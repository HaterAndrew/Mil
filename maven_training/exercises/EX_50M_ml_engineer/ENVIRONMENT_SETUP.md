...
Load `EX_50M_ML_Training_Data/production_model_v2_artifacts/` into training project:
...
Load `EX_50M_ML_Training_Data/current_serving_data_synthetic.csv`:
...
If values deviate significantly, regenerate the dataset using the seed script in `EX_50M_ML_Training_Data/generate_synthetic_data.py`.

### 3. Candidate Model Architectures

Load `EX_50M_ML_Training_Data/candidate_model_architectures/`:
