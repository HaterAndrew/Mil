# ENVIRONMENT SETUP — EX_40C Movement & Maneuver (TM-40C)
...
Load `EX_40C_BCT_Maneuver_Training_Data/` package (from training data package):
...
Place all files in: `[Training Project]/EX_40C/source/`
...
1. Navigate to: `[Training Project]/EX_40C/source/battalion_positions` dataset
