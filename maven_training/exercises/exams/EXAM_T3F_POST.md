# POST-TEST — T3-F: MSC FORCE MULTIPLIER
...
| **Audience** | T3-F candidates completing the course |
| **Time Allowed** | 15 minutes |
| **Passing Score** | N/A — T3-F Go is determined by the teach-back evaluation, not this post-test. This test provides diagnostic data for C2DAO. |
...
C. Use these questions to verify trainee comprehension before moving to the next block
D. Replace the provided questions with their own questions

**3. A performance measure marked as "Critical" in a T&EO means:**

A. It is the most time-consuming performance measure
B. Failure on this measure is automatic No-Go regardless of performance on other measures
...
B. 30 calendar days
C. 5 duty days
D. No reporting is required unless there are No-Go results

**7. A No-Go result must be reported to C2DAO within:**

A. 5 duty days
B. 24 hours
C. At the next semi-annual PD session
D. Only if the student fails re-evaluation

**8. You are in the middle of a Go/No-Go evaluation. A student asks "Can I use my notes from today?" You should:**

A. Check the T&EO condition statement — if notes are authorized, allow it; if not, do not
B. Tell the student no — evaluations are closed book
C. Allow it regardless of the T&EO because it helps the student succeed
D. End the evaluation and start over
...
|---|---|---|---|
| 1 | **B** — complete pre-course checklist | 2 | T3-F Course Content §2-3 |
...
| 9 | (1) Inform the student same-day, privately. (2) Identify which performance measures were not met. (3) Document on T&EO scoring sheet. (4) Coordinate with unit training NCO for remediation. (5) Report to C2DAO within 24 hours. | 3 | T3-F Course Content §3-3 |
| 10 | Deliver as written. Note the potential error. Report to C2DAO after the iteration. Do not freelance a fix during delivery — curriculum authority resides with C2DAO. | 3 | T3-F Concepts Guide §3-1 |
