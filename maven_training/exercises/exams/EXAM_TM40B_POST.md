# POST-TEST — TM-40B: AI ENGINEER
## Maven Smart System (MSS) — USAREUR-AF

| | |
|---|---|
| **Course** | TM-40B: AI Engineer |
| **Form** | Post-Test |
| **Level** | TM-40B (Specialist) |
...
**6. An AIP Logic workflow writes a summarized lesson learned to an Ontology Object upon completion. Per TM-40B standards, this write action must:**
...
**8. You are building an AIP Logic workflow to extract key entities (unit names, grid coordinates, equipment types) from field reports. The LLM is producing inconsistently formatted outputs. The correct iterative improvement approach per TM-40B is:**
...
**SA-2. A new AI engineer on your team argues that the human-in-the-loop requirement slows operations and proposes removing it for "low-risk" workflows. Write your response, citing TM-40B policy and the operational risk of removing the review gate.**
...
**SA-4. An Agent Studio agent with access to an Ontology query tool and a Workshop form submission tool is producing unexpected results — it is submitting Workshop forms without the user explicitly requesting form submission. Describe the root cause and the correct fix using TM-40B tool-use authorization controls.**
...
*TM-40B Post-Test | Version 1.0 | March 2026*
