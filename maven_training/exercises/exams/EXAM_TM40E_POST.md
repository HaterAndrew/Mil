# POST-TEST — TM-40E: KNOWLEDGE MANAGER
...
**1. The five Object Types required in a TM-40E knowledge architecture are:**
...
**4. Per TM-40E, an AIP Logic summarization workflow that processes AAR text MUST include:**
...
**7. A knowledge browser application must support which of the following capabilities per TM-40E?**
...
B. Non-compliant with TM-40E Chapter 9 — it fails the specificity requirement
...
**11. A new AAR submission comes in with the category field tagged as "LOGISTICS" but the content clearly relates to communications. Per TM-40E, the KM officer should:**
...
D. A prohibited use of AI for knowledge management per TM-40E
...
**14. Per TM-40E Section 8-1, which of the following is required before aggregating individual Soldiers' ExpertiseProfiles into a searchable directory?**
...
**SA-3. You are building a PCS knowledge transfer package for a departing brigade S2 NCO who managed two active MSS projects and one AIP Logic workflow. Describe what must be included in the package per TM-40E Chapter 9 procedures. Explain why a generic "key things" document is insufficient.**
...
**Multiple Choice:**
1. B — Document, Lesson, AAR, SOP, ExpertiseProfile are the five TM-40E required Object Types.
...
8. B — Generic documents without project-specific details fail TM-40E Chapter 9 specificity requirement.
...
14. B — Privacy Act review before aggregating individual Soldier profiles is required per TM-40E Section 8-1.
...
*TM-40E Post-Test | Version 1.0 | March 2026*
