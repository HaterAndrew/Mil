# PRE-TEST — TM-50F: ADVANCED SOFTWARE ENGINEER
...
**15. Platform governance at the TM-50F level includes which responsibility that is NOT present at TM-40F?**
...
**SA-4. A junior SWE on your team proposes bypassing CBAC in the staging environment "just for testing" to avoid setting up test data for each tenant. As the TM-50F platform lead, describe your response and explain why this is never acceptable even in non-production environments.**
...
*TM-50F Pre-Test | Version 1.0 | March 2026*
