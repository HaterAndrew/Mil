# EX-50O — Advanced Platform Engineer
...
| **Duration** | 3–4 hours |
| **Environment** | Multi-cluster training environment with fleet management tooling — see EX-40O ENVIRONMENT_SETUP.md (extended environment) |
