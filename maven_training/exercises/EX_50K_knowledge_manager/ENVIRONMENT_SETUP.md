...
Load `EX_50K_KM_Training_Data/km_corpus_synthetic/` (40 documents):
...
Load `EX_50K_KM_Training_Data/unit_continuity_template.md` — standard USAREUR-AF unit continuity package template with sections pre-populated for this rotation scenario.

Load `EX_50K_KM_Training_Data/rotation_roster_synthetic.csv`:
