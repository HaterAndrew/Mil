...
- [ ] Self-review your Python Transform against the TM-40L code quality checklist: no hardcoded values, parameterized configs, no sensitive data in logs, inline comments on non-obvious logic
