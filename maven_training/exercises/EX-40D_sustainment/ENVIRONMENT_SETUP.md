...
Load `EX-40D_BCT_Sustainment_Training_Data/` package (from training data package):
...
Place all files in: `[Training Project]/EX-40D/source/`
...
```
COMMANDER'S SUSTAINMENT CCIR GUIDANCE — EX-40D TRAINING
...
1. Navigate to: `[Training Project]/EX-40D/source/unit_readiness` and `supply_status` datasets
