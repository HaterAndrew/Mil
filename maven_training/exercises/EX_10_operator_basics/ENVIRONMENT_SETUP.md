# ENVIRONMENT SETUP — EX_10 Operator Basics
...
### 1. Dataset
Load `EX_10_BCT_Readiness_Training_Data.csv` (from training data package):
...
### 2. Dashboard
Pre-build or restore "BCT Readiness — EX_10 Training" Workshop dashboard:
...
`[Training MSS project path]/EX_10_template_restore`
