...
- Introduce nulls in `days_since_last_service` (~5%) to require imputation
- Place in: `[Training Project]/EX-40I/source/`
...
- Training accounts must have permission to register model-backed properties
...
- Participants who use accuracy as their primary metric without addressing imbalance should be prompted to explain their choice (this is a teaching moment for Task 3)
