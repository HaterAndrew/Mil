# ENVIRONMENT SETUP — EX_40F Mission Command (TM-40F)
...
Load `EX_40F_bct_ops_training_data/` package (from training data package):
...
Place all files in: `[Training Project]/EX_40F/source/`
...
1. Navigate to: `[Training Project]/EX_40F/source/readiness_status` dataset
