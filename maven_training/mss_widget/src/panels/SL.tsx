...
export default function SL({ showPanel }: Props) {
  return (
    <>
      <div className="section-header">
        <span className="section-badge" style={{background:'rgba(200,151,26,0.18)',color:'var(--gold)'}}>TM-SL</span>
        <span className="section-title">Senior Leader Executive Course</span>
        <span className="section-subtitle">Audience: O-5+ / E-9+ &bull; 1 day &bull; No prerequisites &bull; Terminal &mdash; outside the TM pipeline</span>
      </div>

      <div className="callout bluf">
        <div className="callout-label">BLUF</div>
        <div className="callout-body">TM-SL gives battalion commanders, command sergeants major, and equivalent senior leaders the operational understanding of MSS required to lead formations that depend on data-driven decision-making. You will not build anything. You will learn what the platform produces, how data products affect your formation, and how to direct your staff&rsquo;s use of data as a command function. TM-SL replaces TM-10 for O-5 / E-9+ personnel. It is terminal &mdash; no progression to TM-20 or beyond.</div>
      </div>

      <div className="callout info">
        <div className="callout-label">PUBLICATION</div>
        <div className="callout-body"><strong>TM-SL &mdash; Senior Leader Executive Course</strong> &mdash; Full reference document. &nbsp;<a href={URLS.TM_SL} target="_blank" rel="noopener noreferrer" style={{color:'var(--navy)',fontWeight:700,fontSize:'14px'}}>Open PDF &rarr;</a></div>
      </div>

      <div className="callout warning">
        <div className="callout-label">NOTE</div>
        <div className="callout-body">TM-SL is <strong>outside the TM-10 through TM-50 training chain.</strong> It does NOT grant TM-10 credit. If a senior leader wants hands-on platform qualification, they should enroll in TM-10 and proceed through the standard pipeline.</div>
      </div>
        ...
        <div className="card gold-top">
          ...
          <div className="card-body">
            <ul>
              ...
              <li>The training pipeline that qualifies your data workforce (TM-10 through TM-50)</li>
            </ul>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            <ul>
              ...
              <li>A substitute for TM-10 in the standard pipeline</li>
      ...
      <h2>DOCUMENTS</h2>
      <div className="callout info">
        <div className="callout-label">TM-SL PUBLICATIONS</div>
        <div className="callout-body">
          Course Manual: <a href={URLS.TM_SL} target="_blank" rel="noopener noreferrer" style={{color:'var(--navy)',fontWeight:700}}>TM_SL_SENIOR_LEADER.pdf</a> &nbsp;&bull;&nbsp;
          Concepts Guide: <a href={URLS.CG_TM_SL} target="_blank" rel="noopener noreferrer" style={{color:'var(--navy)',fontWeight:700}}>CONCEPTS_GUIDE_TM_SL.pdf</a> &nbsp;&bull;&nbsp;
          Syllabus: <a href={URLS.SYL_TM_SL} target="_blank" rel="noopener noreferrer" style={{color:'var(--navy)',fontWeight:700}}>SYLLABUS_TM_SL.pdf</a>
        </div>
      </div>
