...
const TASKS: Task[] = [
  ...
  { task: "Create and configure Code Workspace", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["setup","code"] },
  { task: "Manage packages in Code Workspace", tms: [{id:"tm-40g",label:"TM-40G"},{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["setup","code"] },
  { task: "Manage compute and environment resources", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["setup","code"] },
  ...
  { task: "Connect to Foundry datasets in notebook", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["data","code"] },
  { task: "Write output datasets back to Foundry", tms: [{id:"tm-40g",label:"TM-40G"},{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["data","code"] },
  ...
  { task: "Publish predictions as ontology object property", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ontology","ml"] },
  ...
  { task: "Build feature engineering transform", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["code","ml"] },
  { task: "Build feature store entry", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["code","ml"] },
  { task: "Version control in Code Workspaces", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 2", cat: ["code"] },
  ...
  // ── MACHINE LEARNING ─────────────────────────────────────────
  { task: "Train scikit-learn model with experiment tracking", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["ml"] },
  { task: "Hyperparameter tuning with Optuna", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["ml"] },
  { task: "Train PyTorch model on Foundry data", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["ml"] },
  { task: "Compute and document model evaluation report", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 3", cat: ["ml"] },
  { task: "Conduct bias and fairness assessment", tms: [{id:"tm-40m",label:"TM-40M"},{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 3", cat: ["ml"] },
  { task: "Deploy batch inference as Foundry transform", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ml"] },
  { task: "Implement inference caching and freshness indicators", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ml"] },
  { task: "Implement model versioning", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ml"] },
  { task: "Implement drift detection", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ml"] },
  { task: "Configure retraining triggers", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 4", cat: ["ml"] },
  { task: "Complete model card documentation", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 5", cat: ["ml","governance"] },
  { task: "Manage production model incident", tms: [{id:"tm-40m",label:"TM-40M"}], chapter: "Ch 5", cat: ["ml"] },
  ...
  { task: "Design and implement automated retraining pipeline", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 2", cat: ["ml","advanced"] },
  { task: "Fine-tune Transformer for SITREP classification", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 2", cat: ["ml","advanced"] },
  { task: "Build GNN for unit readiness propagation", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 3", cat: ["ml","advanced"] },
  { task: "Implement federated retraining coordination", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 3", cat: ["ml","advanced"] },
  { task: "Implement platform-level interpretability infrastructure", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 4", cat: ["ml","advanced"] },
  { task: "Conduct bias audit for personnel readiness model", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 4", cat: ["ml","advanced"] },
  { task: "Optimize production inference pipeline", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 5", cat: ["ml","advanced"] },
  { task: "Conduct adversarial robustness evaluation", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 5", cat: ["ml","advanced"] },
  { task: "Design shared feature store for MSS ML program", tms: [{id:"tm-50m",label:"TM-50M"}], chapter: "Ch 6", cat: ["ml","advanced"] },
