...
**Last updated:** 17 March 2026 (Analytics apps expansion: 5 new apps, portal v4.0, Section 9 added; changelog #151–157. Prior: DDOF Playbook v2.2 reconciliation #124–135)
...
**Status at generation:** Corpus at v2.0-ready state. All naming and content issues resolved. TM-40D/E/F prereq discrepancy resolved 2026-03-14 — all WFF tracks (TM-40A–F) now require TM-30 as terminal prerequisite. Pre-v2.0 audit complete: 8 content fixes applied (README.md, POLICY_LETTER.md, cheatsheet.md, Home.tsx, TM40.tsx, mss_info_app/index.html, .gitignore, MSS_Project_Overview.pptx); MSS_Training_Progression.pptx specialist column fully rebuilt with clean WFF (A–F) / Specialist (G–M) grouping. PDFs regenerated (3 source-changed files rebuilt). See changelog entry #95–103.
...
TRAIN-THE-TRAINER (T3) — SEPARATE BRANCH
  TM-30 + C2DAO Selection ──→ T3-I (Instructor Certification) ── 5 days classroom + practicum
  TM-20 + CDR Nomination  ──→ T3-F (MSC Force Multiplier)     ── 3 days
```

> **NOTE:** TM-50 is G–M only (advanced specialist tracks). WFF tracks (TM-40A–F) are terminal with no TM-50 continuation.
> WFF tracks (TM-40A–F) require TM-30 (same prereq chain as Specialist tracks) — design decision 2026-03-13.
> Specialist tracks (TM-40G–M) all require TM-30 (required, not recommended).
...
> **Train-the-Trainer (T3)** sits outside the TM-10 to TM-50 numbering chain. T3-I (Instructor Certification) requires TM-30 + C2DAO selection. T3-F (MSC Force Multiplier) requires TM-20 + CDR nomination. Output: Certified Instructor (T3-I) or Unit Data Trainer/UDT (T3-F).
...
CDA "Data 201" (10 decks) ───────────⇢ TM-30 / TM-40G–M
...
| doctrine/enterprise_architecture/EA_05_MILITARY_APPLICATION.md | [EA] | → TM-30, TM-40G–M |
...
### CDA Doctrine (TM-40G–M)
| File | Type | Supports |
|---|---|---|
| doctrine/CDA_CONSTRAINTS_AND_DIRECTIVES.md | [CNCPT] | → TM-40G–M (12 operational constraints and directives governing CDA work) |
| doctrine/cda_doctrine/CDA_OVERVIEW.md | [CNCPT] | → TM-30 (bridge: CDA user taxonomy, enterprise index) |
| doctrine/cda_doctrine/CDA_DOCTRINE_OVERVIEW.md | [CNCPT] | → TM-40G–M (doctrine-driven development) |
...
| doctrine/cda_doctrine/agents/CDA_AGENTS_CORE_PRINCIPLES.md | [CNCPT] | → TM-40H, TM-40M, TM-40K, TM-40L, TM-50H/I/K/L (12 bedrock principles: Stability Stack, Four-Layer Architecture, Scope Engineering, Nine Object Types, Identity Governance, VAULTIS-A, 14 anti-patterns) |
...
| doctrine/cda_doctrine/agents/CDA_AGENTS_ENTITY_RESOLUTION.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (9-stage ER pipeline; blocking, scoring, decisioning, cluster building, survivorship; threshold bands; 10 anti-patterns) |
| doctrine/cda_doctrine/agents/CDA_AGENTS_INGESTION_INTEGRATION.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (Five-Stage Ingestion Pattern; ELT over ETL; Dagster DAG; VAULTIS-A per pipeline; 9 anti-patterns; 10-item output checklist) |
...
| doctrine/gdap/GDAP_VISION.md | [CNCPT] | → TM-40H, TM-40M, TM-40K, TM-40L, TM-50H/I/K/L (full vision: 10 use-case domains, 20 pipeline steps, DVEE, coalition seam detection) |
| doctrine/gdap/GDAP_PERSISTENCE_STRATEGY.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (DuckDB = canonical truth; LlamaIndex = derived serving artifacts; versioning/rebuild/rollback policy) |
| doctrine/gdap/GDAP_ACCEPTANCE_TESTS.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (P0/P1/P2 release gates across 9 sections: A=Foundation, B=Ingestion, C=Retrieval, D=Routing, E=Response Quality, F=Agents, G=Evaluation, H=Ops, I=Consumer Delight) |
| doctrine/gdap/GDAP_ADR_0001_LLAMAINDEX.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (ADR-0001 accepted: DuckDB owns canonical truth; LlamaIndex owns serving artifacts; boundary rules) |
...
| doctrine/mim/MIM_STANDARD.md | [CNCPT] | → TM-40H, TM-40M, TM-40K, TM-40L, TM-50H/I/K/L (MIM semantic model: namespaces, type/instance/status, roles, discriminators, code types, design principles, Semantic IDs) |
| doctrine/mim/MIM_STATE.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (project snapshot 2026-02-28: maturity by area, passing/failing tests, key gaps, 30/60/90 priorities) |
| doctrine/mim/MIM_ACADEMICS.md | [CNCPT] | → TM-40H, TM-40M, TM-40K, TM-40L, TM-50H/I/K/L (Dr. Gerz / NATO interoperability; MIM↔Foundry structural alignment analysis; UML↔OT mapping; MIP governance) |
| doctrine/mim/MIM_DECISION_RECORDS.md | [CNCPT] | → TM-40H, TM-40L (ADR structure decision: repo-level and per-package ADRs) |
| doctrine/mim/MIM_FUTURE_CLASSES.md | [CNCPT] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (planned: mim-studio, mim-ui, adapters, backends, mim-sdk, mim-provenance) |
...
### Canon Reference (TM-40G–M)
| File | Type | Supports |
|---|---|---|
| doctrine/cda_doctrine/canon/CANON_ADP_CROSSWALK.md | [CANON] | → all specialist tracks TM-40G–M |
...
| quick_reference/cda_reference/DOCTRINE_ELEMENT_FOUNDRY_MAPPING.md | [REF] | → TM-40H, TM-40M, TM-40L, TM-50H/I/L (DoctrineElement property map, bi-temporal fields, TypeScript interface, OSDK query patterns, link types, enums) |
...
**Inbound references from:** TM-30, TM-40A–M (prereq chain via TM-30), all training mgmt docs, CHEATSHEET, README
...
| CONCEPTS_GUIDE_TM30_ADVANCED_BUILDER.md | [CNCPT] | ↔ TM_30_ADVANCED_BUILDER [TM] (companion), ⇢ TM-40G–M escalation guide, ⇢ EA Series, ⇢ CDA doctrine |
...
**Inbound references from:** TM-40A–F (all WFF tracks, hard prereq), TM-40G–M (all specialist tracks, hard prereq), TM-40K (pipeline builder), TM-40L (peer note), all training mgmt docs, CHEATSHEET, README
...
## SECTION 3 — SPECIALIST TRACKS (TM-40G–M)
...
## SECTION 4 — ADVANCED SPECIALIST TRACKS (TM-50G–M)
### Prereq for each: corresponding TM-40G–M (required)
...
| TM-50J (Adv PM) | TM-40J | ⇢ TM-40G, TM-40H, TM-40M, TM-40K, TM-40L | TM_50J_PROGRAM_MANAGER_ADVANCED.md + CG |
...
**Syllabi:** SYLLABUS_TM50G–M present and published
**Exams:** EXAM_TM50G–M PRE + POST present
**Exercises:** EX_50G–M directories present (EX_50G_orsa/, EX_50H_ai_engineer/, EX_50M_ml_engineer/, EX_50J_program_manager/, EX_50K_knowledge_manager/, EX_50L_software_engineer/ — each with EXERCISE.md + ENVIRONMENT_SETUP.md)

---

## SECTION 4B — TRAIN-THE-TRAINER (T3)
### Outside the TM-10 to TM-50 numbering chain. Own T3-I/T3-F designation.

### T3-I: Instructor Certification
**Prereq:** TM-30 Go on file + C2DAO selection. **Duration:** 5 days (classroom + practicum). **Output:** Certified Instructor.

| File | Type | Outbound Dependencies |
|---|---|---|
| T3_I_INSTRUCTOR_CERTIFICATION.md | [TM] | → TM-30 (prereq), → CONCEPTS_GUIDE_T3I, ↔ INSTRUCTOR_TIER_DEFINITIONS, ↔ C2DAO_SME_DESIGNATION_RUBRIC |
| CONCEPTS_GUIDE_T3I_INSTRUCTOR_CERTIFICATION.md | [CNCPT] | ↔ T3-I [TM] (companion) |
| SYLLABUS_T3I.md | [SYL] | → TM-30 (prereq) |
| EX_T3I_instructor_certification/EXERCISE.md | [EX] | → T3-I [TM] |
| EX_T3I_instructor_certification/ENVIRONMENT_SETUP.md | [EX] | → T3-I [TM] (environment config) |
| EXAM_T3I_PRE.md | [EXAM] | assesses T3-I readiness |
| EXAM_T3I_POST.md | [EXAM] | assesses T3-I completion |
| T3I_LESSON_PLAN_OUTLINES.md | [LP] | → T3-I [TM] |

**Inbound references from:** INSTRUCTOR_TIER_DEFINITIONS, C2DAO_SME_DESIGNATION_RUBRIC, SUCCESSOR_PLANNING_GUIDE, FACULTY_DEVELOPMENT_PLAN

**Supporting training management docs:**
| File | Type | Supports |
|---|---|---|
| training_management/INSTRUCTOR_TIER_DEFINITIONS.md | [SOP] | → T3-I (tier structure for certified instructors) |
| training_management/C2DAO_SME_DESIGNATION_RUBRIC.md | [SOP] | → T3-I (SME designation criteria for instructor candidates) |
| training_management/SUCCESSOR_PLANNING_GUIDE.md | [SOP] | → T3-I, T3-F (instructor and UDT succession planning) |
| training_management/MTT_OPERATIONS_SOP.md | [SOP] | → T3-I, T3-F (MTT operations for T3 graduates) |

---

### T3-F: MSC Force Multiplier
**Prereq:** TM-20 Go on file + CDR nomination. **Duration:** 3 days. **Output:** Unit Data Trainer (UDT).

| File | Type | Outbound Dependencies |
|---|---|---|
| T3_F_MSC_FORCE_MULTIPLIER.md | [TM] | → TM-20 (prereq), → CONCEPTS_GUIDE_T3F, ↔ UNIT_DATA_TRAINER_SOP |
| CONCEPTS_GUIDE_T3F_MSC_FORCE_MULTIPLIER.md | [CNCPT] | ↔ T3-F [TM] (companion) |
| SYLLABUS_T3F.md | [SYL] | → TM-20 (prereq) |
| EX_T3F_force_multiplier/EXERCISE.md | [EX] | → T3-F [TM] |
| EX_T3F_force_multiplier/ENVIRONMENT_SETUP.md | [EX] | → T3-F [TM] (environment config) |
| EXAM_T3F_PRE.md | [EXAM] | assesses T3-F readiness |
| EXAM_T3F_POST.md | [EXAM] | assesses T3-F completion |
| T3F_LESSON_PLAN_OUTLINES.md | [LP] | → T3-F [TM] |

**Inbound references from:** UNIT_DATA_TRAINER_SOP, SUCCESSOR_PLANNING_GUIDE, COMMANDERS_GUIDE_MSS_TRAINING

**Supporting training management docs:**
| File | Type | Supports |
|---|---|---|
| training_management/UNIT_DATA_TRAINER_SOP.md | [SOP] | → T3-F (UDT duties, responsibilities, and sustainment requirements) |
...
|---|---|---|
| DATA_LITERACY_technical_reference.md | Doctrine/ADP-analog | TM-10, TM-20, TM-30, TM-40G–M, TM-50G–M (all recommended prereq read) |
...
| NAMING_AND_GOVERNANCE_STANDARDS.md | Standards | EX_20, EX_30 (required read); TM-40M Appendix A, TM-40L Appendix B |
| cheatsheet.md | Quick Reference | Standalone; links to all TMs A–M, 50G–M, base tracks |
...
|---|---|---|
| MTP_MSS.md | Master training plan; course overview table + TM-10 throughput risk item (Sec 7-4, G-3 action required) | All TMs; corrected durations: TM-20=5d, TM-30=5d, TM-40A–F=3d, TM-40G/H/M/L=5d, TM-40J/K=4d |
| POI_MSS.md | Program of instruction; tier/prereq structure | All TMs; prereq tree A–M; TM-40J/K now correctly in TM-30 branch |
...
| FACULTY_DEVELOPMENT_PLAN.md | Instructor quals by track | All TMs; WFF (A–F) vs. Specialist (G–M) instructor profiles |
| COMPLETION_CERTIFICATE.md | Certificate templates | Generic; course title filled at completion |
| CURRICULUM_MAINTENANCE_SOP.md | Maintenance SOP + Platform Monitoring procedure (Sec 2A) + Semi-Annual Deep Review (Sec 5A) | Scope: TM-10 through TM-40M |
...
| TM40_SPECIALIST_LESSON_PLAN_OUTLINES.md | Lesson plans: TM-40G–M | All specialist tracks G–M; WFF A–F managed separately with WFF proponents |
...
| lesson_plans/TM50_ADVANCED_LESSON_PLAN_OUTLINES.md | Lesson plans: TM-50G–M advanced tracks | All advanced tracks G–M |
| lesson_plans/T3I_LESSON_PLAN_OUTLINES.md | Lesson plans: T3-I Instructor Certification | T3-I (5-day classroom + practicum) |
| lesson_plans/T3F_LESSON_PLAN_OUTLINES.md | Lesson plans: T3-F MSC Force Multiplier | T3-F (3-day UDT course) |
| INSTRUCTOR_TIER_DEFINITIONS.md | Instructor tier structure and qualification levels | T3-I, FACULTY_DEVELOPMENT_PLAN |
| C2DAO_SME_DESIGNATION_RUBRIC.md | SME designation criteria for instructor candidates | T3-I |
| UNIT_DATA_TRAINER_SOP.md | UDT duties, responsibilities, and sustainment requirements | T3-F |
| MTT_OPERATIONS_SOP.md | MTT operations procedures for T3 graduates | T3-I, T3-F |
| SUCCESSOR_PLANNING_GUIDE.md | Instructor and UDT succession planning | T3-I, T3-F |
| atis/ATIS_COURSE_PACKET.md | TR 350-70 ATIS course registration packet — all 21 courses; structured for G3/7 (Phase 1) and T2COM (Phase 2) | → POI, → CAD, → MTP, → TEO; all TM levels; all syllabi |
| atis/atis_courses.json | Machine-readable structured course data (JSON); same content as ATIS_COURSE_PACKET.md | → POI, → CAD, → MTP, → TEO |
...
|---|---|---|
| mss_info_app/index.html | Training hub — 6 WFF cards (A–F, TM-30 chip) + 6 specialist cards (G–M, TM-30 chip) + 6 TM-50 cards | All TM-40A–M PDFs, all CGs, all exams, all syllabi |
| mss_info_app/training_schedule.html | Schedule view | Training schedule data |
| task_index.html | Task index by specialist track | TM-40G(17 tasks), TM-40H(1), TM-40M(21), TM-40J(18), TM-40K(6), TM-40L(30) = 93 total |
...
| # | Files Added | Destination | Level |
|---|---|---|---|
| 74 | doctrine/CDA_CONSTRAINTS_AND_DIRECTIVES.md | 12 CDA operational constraints; governs all specialist CDA work | TM-40G–M |
| 75 | doctrine/cda_doctrine/CDA_DOCTRINE_OVERVIEW.md | Doctrine-driven development framework; DDD applied to CDA | TM-40G–M |
...
| 84 | doctrine/enterprise_architecture/EA_05_MILITARY_APPLICATION.md | EA applied to military C2 / joint operations context | TM-30, TM-40G–M |
| 85 | doctrine/cda_doctrine/canon/CANON_ADP_CROSSWALK.md | ADP 3-0 / 6-0 crosswalk to Foundry data model | TM-40G–M |
...
**Scope:** Team-of-teams content accuracy and consistency audit across all curriculum files, React widget, HTML app, Python scripts, and PPTX presentation files. Primary goal: verify prereq chain enforcement (TM-30 hard prereq for ALL TM-40 tracks A–F and G–M) and content alignment between all delivery surfaces.
...
| 102 | maven_training/pdf/MSS_Project_Overview.pptx | Slide 1: old "6 Specialist Tracks: 40A ORSA · 40B AI · 40C MLE..." scheme | Rebuilt via python-pptx: "12 Tracks (WFF + Specialist) / WFF (A–F): Intel · Fires · M&M / Specialist (G–M): ORSA · AI Eng · MLE · PM · KM · SWE" |
| 103 | maven_training/pdf/MSS_Training_Progression.pptx | Specialist column: original 6-slot design insufficient; partial fix left WFF A–D mixed with specialist H–I, sub-headers misplaced | Full column rebuild via python-pptx: deleted all 19 old content shapes; clean layout with "▸ WFF TRACKS (A–F)" (A–F) / "▸ SPECIALIST (G–M)" (G–M) sub-headers; TM-50 G–M note added at bottom |
...
| 115 | 13 TM files (TM-10, TM-40A–M) | No professional reading lists | Added Professional Reading List appendices with 65+ curated journal articles |
...
| UDRA v1.1 (Feb 2025) | Data mesh, decentralized governance | TM-30, TM-40G–M, TM-50G–M |
