...
## External Alignment — Army Institutional Programs

The USAREUR-AF data architecture and training investment aligns with — and in several areas leads — emerging Army institutional programs. Awareness of these validates our approach and identifies future integration opportunities.

| Program | Proponent | Status | Alignment |
|---|---|---|---|
| CAC Maven C2 Integration | MCCoE/CGSC/CAC C2DAO | Active (Feb 2026 T3 session) | Institutional Army integrating Maven into PME and operator training. Our TM-10–30 courses cover the same competencies the 8-hour MCCoE operator course and CAC Builders Course will deliver. |
