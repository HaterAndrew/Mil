...
MTP | POI | CAD | TEO | Enrollment SOP | Faculty Dev Plan | Curriculum Maintenance SOP

---

## THE PROBLEM

No organic MSS training capability exists anywhere. ODT absorbs training by default. Partner nations requesting access with no delivery mechanism. Content is built; delivery is not.

---

## COURSES OF ACTION

| COA | Description | Throughput | Partners |
|-----|-------------|------------|----------|
...
## RECOMMENDED ACTION — TASKORD (COA 1)

| Tasking | OPR | NLT |
|---------|-----|-----|
| 5 MTT billets via TDA | G1 | D+30 |
| FY26 TDY funding | G8 | D+30 |
| SJA review (IP, partner legal) | SJA | D+30 |
| App on network subdomain | G6 | D+45 |
