...
## Maven Smart System (MSS) Training Program — FY2026
### USAREUR-AF Operational Data Team — C2DAO

| | |
|---|---|
| **Fiscal Year** | FY2026 (Oct 2025 – Sep 2026) |
| **Published By** | C2DAO Training Division |
| **Effective** | March 2026 (mid-year revision) |
| **Review Date** | September 2026 (for FY2027 schedule) |
...
| Schedule Changes | C2DAO provides 30-day notice of course cancellation. Units maintain a waitlist for each enrolled course to rapidly refill cancelled seats. |
...
**NOTE:** Day 1 Block 1 (AI Safety) cannot be rescheduled. Trainees who cannot attend Day 1 in full should not enroll.
...
**NOTE:** Trainees must bring configured personal laptop (Node.js LTS, TypeScript, IDE) on Day 1.
...
### Minimum Advance Planning Timeline
...
## SCHEDULE REQUESTS AND MODIFICATIONS

To request a new class date, additional quota, or schedule modification:
1. Submit request via unit MSS Administrator to C2DAO Training POC
2. Include: course, number of students, preferred dates (two options), access provisioning status
3. C2DAO will respond within 5 duty days
