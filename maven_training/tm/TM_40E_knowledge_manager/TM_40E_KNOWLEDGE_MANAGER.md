...
Before performing any task at TM-40E level:
...
> **NOTE:** TM-40E graduates design knowledge systems that outlast their assignments. Every architecture decision should be evaluated against the question: "Will the Soldier replacing me be able to understand, maintain, and extend this system after a two-week handoff?"
...
| S6 Data NCOIC | Pipeline configurations, data source contacts, error handling procedures | TM-40E qualified successor; documented pipeline runbook |
...
**MSS (Maven Smart System).** The USAREUR-AF enterprise AI/data platform, built on Palantir Foundry. The deployment environment for all TM-40E knowledge management systems.
...
*TM-40E — Knowledge Manager Technical Manual*
