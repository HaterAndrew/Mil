# CONCEPTS GUIDE — TM-40E COMPANION
## KNOWLEDGE MANAGER
...
**PURPOSE:** This guide develops the mental models required to design, implement, and maintain knowledge management solutions on MSS effectively. It is a prerequisite companion to TM-40E and is intended to be read before beginning TM-40E task instruction.
...
| **Knowledge Manager (TM-40E)** | **Institutional knowledge architecture** | **Ontology Manager, Workshop, AIP** | **Information architecture, governance** |
...
*This guide is a prerequisite companion to TM-40E. Personnel should read this guide in full before beginning TM-40E task instruction. The mental models developed here underpin every task in TM-40E and are not repeated in the task manual.*
