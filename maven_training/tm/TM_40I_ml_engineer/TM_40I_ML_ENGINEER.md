...
> **NOTE — Palantir Developers reference:** *Pipeline Monitoring | How to Start Monitoring Data Health in Palantir Foundry* — Covers foundational pipeline health monitoring in Foundry, including setting up dataset checks and health indicators. This is the starting point for implementing the monitoring infrastructure described throughout this chapter. Available on the Palantir Developers YouTube channel (@PalantirDevelopers).
