...
**PURPOSE:** This guide develops the mental models required to manage data pipelines, programs, and portfolio health on MSS effectively. It is a prerequisite companion to TM-40D and is intended to be read before beginning TM-40D task instruction.
...
This guide builds that mental model across nine areas of PM practice. Read it linearly before beginning TM-40D task instruction. Return to individual sections as needed when specific challenges arise in practice.
...
## TRANSITION TO TM-40D TASK INSTRUCTION
...
Proceed to TM-40D for task-based instruction on executing these responsibilities within the MSS environment.

---

*CONCEPTS GUIDE — TM-40D COMPANION | DATA PROGRAM MANAGER | MAVEN SMART SYSTEM*
