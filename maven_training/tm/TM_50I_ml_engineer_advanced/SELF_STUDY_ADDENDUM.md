# Self-Study Addendum — TM-50I Advanced Machine Learning Engineer
## Palantir Developers Reference Library

> **NOT REQUIRED FOR QUALIFICATION.** This addendum provides curated references from the Palantir Developers YouTube channel ([@PalantirDevelopers](https://www.youtube.com/@PalantirDevelopers)) for senior MLEs who want to extend their platform knowledge beyond the core curriculum. All content is publicly available. TM-50I personnel are expected to have already worked through the TM-40I addendum; this addendum extends it with advanced platform, architecture, and enterprise-scale topics.

---

## How to Use This Addendum

Videos are organized from foundational (inherited from TM-40I scope) through advanced (TM-50I platform and architecture focus). Senior MLEs should prioritize Groups 3–8, which address the platform design, enterprise scale, and cross-platform integration topics central to TM-50I responsibilities. Groups 1–2 are retained from the TM-40I addendum for completeness.

---

## Group 1 — PySpark Fundamentals

*(Inherited from TM-40I addendum — included for completeness. TM-50I MLEs should be fluent in this material.)*
...
*(Inherited from TM-40I addendum. TM-50I MLEs set code review standards for this toolchain.)*

| Video | What it Covers | Relevant TM Chapter |
|---|---|---|
| *Code Repositories \| How to Write Data Transformations in Palantir Foundry* | Core Transform authoring procedure — the baseline all MLEs reviewed in TM-40I | Ch 8 (code review standards) |
...
Production-grade pipeline design for the ML platform infrastructure TM-50I MLEs design and maintain.
...
| *Foundry Reference Project \| Structure* | Reference project structure and repository layout conventions; the standard TM-50I MLEs should enforce for ML program repositories | Ch 8 (code review, team development) |
...
On-demand and streaming inference patterns; the AIP integration interface that TM-50I MLEs design the platform side of.
...
| Video | What it Covers | Relevant TM Chapter |
|---|---|---|
| *Palantir Ontology Overview* | Conceptual Ontology overview — Object Types, properties, relationships. Platform context for the model output publication patterns in TM-40I and TM-50I | Ch 8 (platform architecture) |
...
## Group 8 — Advanced Platform and Enterprise Scale (TM-50I Specific)

DevCon 5 content focused on enterprise-scale ML platforms, interoperability, and organizational AI capability. Targeted at TM-50I MLEs designing the platform, not operating within it.
...
| *Building Enterprise Autonomy with Shyam Sankar, CTO* | Strategic framing of enterprise AI and autonomous workflows from Palantir's CTO; relevant to TM-50I MLEs who advise leadership on ML platform direction and the role of automated systems in operational decision chains | Ch 1, Ch 2 (automated MLOps governance) |
