...
Before performing any task at TM-40C level:
...
**BLUF:** TM-40C qualifies machine learning engineers to build, train, evaluate, deploy, and maintain ML models on the Maven Smart System (MSS) within USAREUR-AF. This manual covers the full ML lifecycle — from Code Workspace setup through production model governance.

This manual provides task-based instruction for machine learning engineers (MLEs) operating on MSS. MSS is the USAREUR-AF enterprise AI/data platform built on Palantir Foundry. TM-40C qualified personnel design and implement predictive models, feature pipelines, and ML-backed data products that support operational decision-making across V Corps, 21st TSC, USAREUR-AF G2, and subordinate commands.
...
*TM-40C, Maven Smart System (MSS) Machine Learning Engineer Technical Manual*
