---
title: TM-50D — Advanced Program Manager (Technical)
...
# TM-50D
## TECHNICAL MANUAL
## ADVANCED PROGRAM MANAGER (TECHNICAL)
## MAVEN SMART SYSTEM
...
> **NOTE: This manual assumes full mastery of TM-40D content. Chapter references to TM-40A through TM-40F indicate the technical tracks managed by TM-50D program managers — not prerequisites for the PM role itself. Cross-references are provided to help TM-50D graduates understand the work they are overseeing.**
...
- Appendix D — PM Onboarding Guide for TM-50D Programs
- Glossary
...
## 1-3. Relationship to TM-40D and the Technical Tracks

TM-50D program managers oversee the work of TM-40D project managers and the technical practitioners in tracks TM-40A through TM-40F. Understanding what each track produces — and what failure looks like in each — is essential for program-level oversight.

**Table 1-2. Technical Tracks Managed by TM-50D**

| Track | Role | What They Build | Common Failure Mode |
|-------|------|-----------------|---------------------|
| TM-40A | ORSA | Analytical models, campaign analysis, optimization | Over-engineered models that outrun user comprehension |
| TM-40B | AI Engineer | AI pipeline architecture, model deployment, AIP | Technically correct pipelines that solve the wrong problem |
| TM-40C | ML Engineer | ML model development, training, evaluation | Models that degrade silently in production |
| TM-40D | Tech PM | Project delivery, stakeholder management, product release | On-time delivery of the wrong product |
| TM-40E | Knowledge Manager | Ontology, data governance, KM architecture | Perfect data models no one uses |
| TM-40F | Software Engineer | Custom transforms, integrations, API layers | High-quality code solving problems that could be configured |

TM-50D graduates must recognize failure modes across all tracks and understand how to intervene at the program level — not by doing the technical work, but by restructuring teams, realigning priorities, removing blockers, or escalating to C2DAO leadership.
...
## 1-4A. The TM-50D Program Manager Profile

The TM-50D program manager is not the most technically skilled person on the team. The ORSA (TM-50A), AI Engineer (TM-50B), or ML Engineer (TM-50C) will typically have deeper technical expertise in their domains. The TM-50D's value is integrative: the ability to hold a coherent picture of the entire program simultaneously, to make decisions under uncertainty with incomplete information, and to maintain the trust of both senior leaders and technical practitioners.

**Table 1-3. TM-50D Competency Profile**

| Competency Domain | Key Behaviors | Development Path |
|-------------------|--------------|-----------------|
| Program-level thinking | Sees portfolio risk, not just project risk; understands how individual decisions affect the whole | Managing 3+ concurrent TM-40D-level projects; PI Planning facilitation experience |
| Technical fluency | Understands enough of each technical track to ask the right questions and recognize when answers are implausible; reads code and data schemas | Completion of TM-40D; familiarity with TM-40A through TM-40F content; regular sprint reviews |
...
These are program-level problems. No TM-40D PM can resolve them alone — because the answer may require trading off one team's sprint plan against another's. Only the program manager, with visibility across all teams, can make that call.
...
| External feed | A pipeline depends on a data feed from outside the MSS (S2, G4, partner nation systems) | Very High | Establish SLA with feed owner; build resilience into pipeline design (TM-40F) |
...
|---------------|------------------------|-----------------|----------|
| Technical disagreement (architecture, naming, schema) | Team leads + Platform Lead (TM-50E/TM-50F) resolve jointly | Program Manager facilitates if unresolved in 48 hours | Resolve within 1 sprint |
...
Scaled Agile requires additional ceremonies beyond the single-team standard. TM-50D program managers must design a ceremony cadence that provides cross-team coordination without ceremony overload.
...
At the TM-40D level, project tracking is focused on one team's sprint board, backlog, and burn-down. At the TM-50D level, the audience changes. You are building dashboards for the USAREUR-AF G6, the C2DAO Chief, and potentially the DCG or CG. These leaders do not need sprint-level detail. They need answers to four questions:
...
**CONDITIONS:** C2DAO has approved the program tracking workspace. The program manager has a list of active projects, teams, and current PI objectives. TM-40D PMs on each project team are responsible for populating project-level data.
...
TM-40D stakeholder management focused on working-level relationships: requirements gathering from G-staff analysts, user story validation with battalion S2/S3 shops, and change management with end users adopting new dashboards. TM-50D stakeholder management operates at a different level. You are now communicating with Generals, Senior Executive Service civilians, and senior NATO partners who set budget priorities, sign task orders, and determine whether the MSS program grows or contracts.
...
> **WARNING: Do not use delivery metrics to evaluate individual personnel performance. Velocity is a team metric, not an individual metric. Using sprint velocity as a proxy for individual productivity is a well-documented antipattern that destroys team trust and incentivizes gaming the metric. TM-50D program managers who use metrics punitively will degrade the teams they are supposed to enable.**
...
1. **Ask, don't tell.** The program manager asks Team Bravo's TM-40D PM: "I'm seeing a velocity drop over the last three sprints. Walk me through what's been different."

2. **Look at what changed.** The PM reports: Sprint N-2 was normal; Sprint N-1 began after the senior ML engineer (TM-40C) rotated out; Sprint N began after a major Foundry platform update that required the team to adapt three of their pipelines mid-sprint.
...
> **NOTE: The most common mistake at program scale is building what can be configured. When a requirement arrives, the TM-50D program manager's first question is always: "What can MSS do out of the box that addresses this?" Only after a clear negative answer — documented and validated by the technical leads — should a build decision proceed.**
...
The MSS operating model combines government staff (military and civilian), Palantir forward-deployed engineers (FDEs) and deployment strategists (DSs), and other contractors operating under task orders. Understanding who does what — and who is accountable for what — is essential for the TM-50D program manager.
...
| Government PM (TM-50D) | Military/civilian | Program delivery, task order acceptance, requirements validation, team health | Platform architecture decisions made by Palantir; platform bugs or outages |
...
The TM-50D program manager is responsible for maintaining performance documentation that informs future task order awards and modifications.
...
At program scale, the TM-50D manager makes structural decisions that TM-40D PMs cannot: how many teams, how large, what skill mix, what reporting relationships, how to handle shared services (data engineering, ontology governance, security). These decisions have long-term consequences — restructuring mid-program is costly and disruptive.
...
> **NOTE: For most USAREUR-AF MSS programs at current scale, the recommended structure is Platform Team + Stream-Aligned Feature Teams. The platform team (typically TM-40E KM and TM-40F SWE) owns ontology governance, shared pipelines, and data quality standards. Stream-aligned feature teams own product delivery within their operational domain.**
...
|------|-------|---------------|-------|
| Technical PM | TM-40D | 1 | Required; team lead for delivery |
| ORSA | TM-40A | 1-2 | Required if team is producing analytical products |
| ML Engineer | TM-40C | 1 | Required if team is building or maintaining ML models |
| AI Engineer | TM-40B | 0-1 | Required if team is deploying production AI pipelines or AIP integrations |
| Software Engineer | TM-40F | 1-2 | Required for custom transforms; optional if team is primarily configure-mode |
| Knowledge Manager | TM-40E | 0-1 | Required if team owns ontology objects; may be shared from platform team |

**Table 8-3. Platform Team Composition**

| Role | Track | Count | Notes |
|------|-------|-------|-------|
| Platform Lead | TM-50F or TM-50E | 1 | Oversees ontology, shared pipelines, governance |
| Knowledge Manager (Senior) | TM-50E | 1-2 | Owns ontology governance; data standards |
| Software Engineer (Senior) | TM-50F | 1-2 | Owns shared pipeline infrastructure; code standards |
| Data Quality Lead | TM-40E or TM-40A | 1 | Owns data quality standards and monitoring |
...
**BLUF:** TM-50D program managers are responsible for the professional development of TM-40D PMs they supervise. This is a leadership function, not just a management function.
...
**Table 8-4. TM-40D to TM-50D Development Milestones**

| Competency | TM-40D Standard | TM-50D Ready Standard |
|------------|----------------|----------------------|
...
TM-50D program managers set the standards that all TM-40D PMs on the program are expected to meet. These standards should be written down, communicated at program onboarding, and enforced consistently.
...
| Definition of Done | No feature marked complete without full Definition of Done checklist signed off (see TM-40D Appendix B) |
...
A common failure mode in Agile programs is to treat governance as the enemy of delivery — a layer of process and approval that slows teams down and exists primarily to satisfy auditors. This is wrong, and a TM-50D program manager who holds this view will build a program that is fast, fragile, and ungovernable.
...
TM-40D introduced project-level governance: Definition of Done, access management, sprint ceremonies, and stakeholder sign-off. TM-50D governance operates at the program level: who can approve changes to the ontology? Who authorizes a new production release? Who decides when to retire a product? These decisions affect multiple teams and multiple operational users simultaneously. They require documented authority and consistent process.
...
The MSS program operates under a layered policy framework. TM-50D program managers are responsible for understanding the requirements at each layer and ensuring program compliance.
...
**BLUF:** The TM-50D program manager is the single point of integration for information flowing between technical teams, operational stakeholders, and senior leadership. Information that is not surfaced clearly and on time becomes a liability.

At TM-40D level, communication is primarily project-scoped: stakeholder updates on one project, sprint review reports for one team, escalations on one blocker. At TM-50D level, the program manager is synthesizing information from five to ten teams simultaneously, integrating technical status with operational impact, and translating between the language of Agile delivery and the language of military readiness reporting.
...
**BLUF:** The program manager who communicates program failure clearly and early, with a mitigation plan, builds more trust than the PM who papers over problems until they are unavoidable. The ability to communicate bad news well is a core TM-50D competency.
...
| Data availability | Required input data available and stable for >Y% of records | Data quality assessment (TM-40C) |
| Operational feasibility | Model outputs can be integrated into MSS workflow without >Z weeks of additional development | Technical feasibility review with TM-40B |
...
Army CIO Memo (April 2024) establishes requirements for AI system governance. The TM-50D program manager is accountable for ensuring compliance across all AI-assisted MSS products.

**Table 11-3. AI Governance Checklist — TM-50D Accountability**
...
| Performance monitoring | Model performance metrics tracked; alert thresholds defined | Review monitoring dashboard (TM-40C product) |
...
**BLUF:** The TM-50D program manager does not manage contracts or obligation rates. The PM does manage the allocation of team capacity — the most finite and non-recoverable resource in the program. A sprint-week of engineering capacity spent on the wrong priority is gone permanently.
...
The TM-50D program manager will periodically need to justify the MSS program investment to leadership — especially when budget pressures mount, when a new leader arrives skeptical of data platforms, or when a competing priority threatens to draw resources away from the program.
...
**BLUF:** Data programs operate inside organizations that are themselves changing. Personnel rotate, command priorities shift, platform capabilities evolve, and policy frameworks update. The TM-50D program manager must lead the program through transitions without losing the momentum of ongoing delivery.
...
| Action | Timing | Owner |
|--------|--------|-------|
| Subscribe to Palantir release notes and deprecation notices | Ongoing | Platform Team Lead (TM-50F) |
| Maintain a platform dependency inventory: which products use which APIs | Quarterly review | Platform Team Lead (TM-50F) |
...
- Owner: Team Alpha (TM-40D: CPT Rodriguez)
...
- Owner: Team Bravo (TM-40D: Mr. Harrison)
...
- Success criteria: Model passes production readiness gate (TM-40C checklist); G1 chief reviews and accepts model validation results; human review workflow documented and tested with G1 analysts.
- Owner: Team Charlie (TM-40D: SFC Washington)
...
- Owner: Platform Team (TM-50E: Ms. Nakamura)
- Confidence: High

**PIO 5: PM Capability Development**
Conduct PM capability assessments for all four TM-40D PMs; develop and begin executing individual development plans.
...
- Owner: Team Delta (TM-40D: CW3 Patel)
...
- Model production release process (PIO 3) worked well. TM-40C checklist and G1 review gate are now standard and should be referenced in next PI's model releases.
...
This appendix provides a structured onboarding guide for a new TM-40D PM joining an active TM-50D-managed program. Use this guide to ensure new PMs have the context, access, and knowledge they need to be productive within their first sprint.
...
New TM-40D PMs joining an active program under TM-50D oversight tend to make predictable mistakes. The program manager should brief these proactively — not wait to discover them through sprint failures.
...
By the end of 30 days, the incoming TM-40D PM should be able to:
...
|-------------|-------|-------------|
| TM-40D | Program Manager (Technical) | Prerequisite; this manual builds directly on TM-40D content |
| TM-40A | ORSA | Technical track managed by TM-50D; reference for understanding ORSA deliverables |
| TM-40B | AI Engineer | Technical track managed by TM-50D; reference for AI pipeline delivery standards |
| TM-40C | ML Engineer | Technical track managed by TM-50D; reference for ML model lifecycle |
...
*TM-50D — Advanced Program Manager (Technical)*
