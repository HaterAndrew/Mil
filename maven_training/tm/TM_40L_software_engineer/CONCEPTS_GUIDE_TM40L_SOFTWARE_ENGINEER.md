...
**PURPOSE:** This guide develops the mental models required to write, deploy, and maintain code on MSS effectively. It is a prerequisite companion to TM-40L and is intended to be read before beginning TM-40L task instruction.
