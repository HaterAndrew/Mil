...
- Learn MSS informally from a coworker (unstandardized, unevaluated, potentially wrong)
...
## SECTION 2 — THE EVALUATOR MINDSET

### 2-1. The Switch

During instruction, you help. During evaluation, you observe. The trainees must know when the switch happens.
...
You will evaluate people from your own unit. If the trainee does not meet the standard, the answer is No-Go. A No-Go is not a punishment — it means the trainee needs more practice. A false Go harms the trainee operationally and harms data quality.

When unsure:
- Re-read the T&EO standard — the standard is the arbiter, not your judgment
- If you assisted during evaluation — even a small hint — the evaluation is void
- When genuinely uncertain, score No-Go and document why

---

## SECTION 3 — KNOWING YOUR LIMITS

### 3-1. The Escalation Decision

The most important UDT skill is knowing when to say "this is beyond my scope."
