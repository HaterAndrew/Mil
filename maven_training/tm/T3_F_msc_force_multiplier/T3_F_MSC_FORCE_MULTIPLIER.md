...
> **Forward:** T3-F certifies MSC-level personnel as Unit Data Trainers (UDTs) to deliver SL 1 independently at their units between MTT visits. Half-day course. Graduates receive the lesson plan, prove they can deliver it, and start training.
> **Prereqs:** SL 2, Builder (Go on file); unit commander nomination.
...
**BLUF:** C2DAO cannot be everywhere. USAREUR-AF is distributed across Europe. Between MTT visits, new arrivals need SL 1 (Maven User) qualification. UDTs fill that gap by delivering SL 1 using published lesson plans.

**T3-F covers** how to use the SL 1 training materials (lesson plans, exercises, exams, T&EOs); how to deliver SL 1 using the published lesson plans; how to administer and score SL 1 evaluations (pre-tests, post-tests, Go/No-Go practicals); and how to report training completion to C2DAO.

**T3-F does NOT cover** delivering SL 2, SL 3, or any SL 4/SL 5 course (requires C2DAO-certified instructor); modifying curriculum, lesson plans, or evaluation criteria (curriculum authority resides with C2DAO); or advanced instructional methodology — see T3-I (Instructor Certification).
...
MSC / Unit Level
  └── Unit Data Trainer (T3-F graduate)
        ├── Delivers SL 1 to new arrivals between MTT visits
        ├── Proctors SL 1 exams for self-study/remote personnel
...
|---|---|
| SL 2 Go | On file with C2DAO. Ensures Builder-level platform skills. |
...
| Can Do | Cannot Do |
|---|---|
| Deliver SL 1 (all 9 blocks) | Deliver SL 2 or above |
| Administer SL 1 Go/No-Go evaluations | Modify curriculum or evaluation criteria |
| Proctor SL 1 pre/post exams (standalone) | Grant enrollment exceptions |
| Report training status to C2DAO | Certify other instructors or UDTs |
| | Provision MSS accounts |

---

## CHAPTER 2 — THE SL 1 TRAINING MATERIALS
...
|---|---|---|
| SL 1 Course Content | `tm/TM_10_maven_user/TM_10_MAVEN_USER.md` | Primary reference; student reading material |
| SL 1 Lesson Plans | `training_management/lesson_plans/TM10/TM10_LESSON_PLANS.md` | Block-by-block delivery guide with instructor notes, activities, check-on-learning questions |
| SL 1 Syllabus | `syllabi/SYLLABUS_TM10.md` | Schedule, learning objectives, assessment criteria |
| SL 1 Exercise | `exercises/EX-10_operator_basics/EXERCISE.md` | Practical exercise task list with Go/No-Go criteria |
| SL 1 Pre-Test | `exercises/exams/EXAM_TM10_PRE.md` | Diagnostic exam (Day 1 morning) |
| SL 1 Post-Test | `exercises/exams/EXAM_TM10_SUPPLEMENTAL.md` | Knowledge check (end of course) |
| SL 1 T&EOs | `training_management/TEO_MSS.md` (Part I) | Go/No-Go performance measures and standards |

### 2-2. How to Use the Lesson Plans

Each SL 1 lesson plan block contains:
...
## CHAPTER 3 — DELIVERING SL 1

### 3-1. Course Flow

SL 1 is a 1-day course with 9 blocks:
...
**Critical items** are marked in the T&EO. Failure on any critical item is automatic No-Go for the entire task. SL 1 critical items include correct classification marking on export (TM10-06) and not navigating to the production environment.
...
After each SL 1 iteration, submit the Unit Training Status Report to C2DAO within 5 duty days. Key fields:
- UDT name and unit
- Iteration dates
...
UDTs may proctor SL 1 exams for personnel who completed SL 1 via self-study or remote instruction. Verify the student completed all required reading, administer the post-test under standard conditions, and coordinate with C2DAO for practical exercise scheduling.

### 4-3. Sustainment

- Deliver SL 1 at least quarterly to maintain UDT designation
...
If a training request exceeds your authority (SL 2+, enrollment exceptions, curriculum changes), say so and connect the requestor with C2DAO. If you encounter an environment issue you cannot resolve quickly, escalate to C2DAO. Attempting training beyond your scope causes more harm than delaying until C2DAO is available.
