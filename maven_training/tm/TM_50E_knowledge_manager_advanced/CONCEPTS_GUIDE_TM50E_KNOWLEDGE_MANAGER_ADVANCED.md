# CONCEPTS GUIDE — TM-50E COMPANION
...
This guide is conceptual, not procedural. It does not teach you how to build a Workshop application or configure an Ontology Object Type — TM-40E and TM-50E cover those tasks. This guide teaches you how to think at the enterprise level: how to reason about knowledge systems that span multiple organizations, survive personnel rotation, integrate AI augmentation responsibly, and produce measurable outcomes for the commands they serve.

Read this guide before beginning TM-50E tasks. Return to relevant sections when you encounter design decisions that have no obvious right answer — enterprise KM is full of them. The goal is not to memorize frameworks but to develop the professional judgment that TM-50E demands.
...
9. Advanced Failure Modes — What TM-50E KMs Get Wrong
...
**BLUF:** At TM-50E level, you are no longer maintaining a knowledge system. You are designing how the organization learns — a fundamentally different mandate with fundamentally different consequences if executed poorly.
...
Strategic KM — the TM-50E level — is concerned with the full learning cycle:
...
*CONCEPTS GUIDE — TM-50E COMPANION | ADVANCED KNOWLEDGE MANAGER | MAVEN SMART SYSTEM (MSS)*
