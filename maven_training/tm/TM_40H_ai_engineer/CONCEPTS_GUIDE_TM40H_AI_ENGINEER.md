...
| **ML Engineer (TM-40I)** | Trained models, validation pipelines, model-backed Object properties | Code Workspaces, inference transforms, Foundry datasets | Prompt design, Agent orchestration, operational workflow UX |
