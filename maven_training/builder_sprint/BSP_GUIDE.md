...
> **BLUF:** The Builder Sprint is a quarterly 5-day supervised build event. You bring a validated operational problem. You build a solution. SMEs are in the room for consultation. Minimal instruction — this is not a course. You leave with a functional product and a handoff package.
> **Prereq:** TM-20 (Builder) Go on file + command-approved project.
> *HQ USAREUR-AF · v1.0 · 2026 · DISTRIB: USG only · AUTH: C2DAO/UDRA v1.1*

---

## 1. WHAT THE BUILDER SPRINT IS

The Builder Sprint is not part of the TM-10 through TM-50 training sequence. It does not grant TM-30 credit or unlock TM-40 enrollment. It is a separate, standalone event for personnel who:
...
The sprint exists because the best learning often happens when someone has a problem they actually need to solve. The training environment, synthetic exercises, and structured curriculum of TM-20/30 are essential — but some people learn faster when their problem is on the line.

BSP is that opportunity. Build something real, with support, under a governance-aware environment.

**The sprint does not replace TM-30.** If you need structured instruction on advanced platform skills, enroll in TM-30. BSP assumes you can already operate the platform at TM-20 level and supplements that by putting you in a room to apply those skills to a real problem.
...
| Command-approved project | Validated Project Brief approved by C2DAO coordinator ≥14 days before sprint Day 1 |
| Command sponsorship | Supervisor signature on enrollment request |

TM-30 qualification is not required and not necessary. Personnel who hold TM-30 may attend BSP if they have an operational project and want supervised build time — the sprint is open to any TM-20+ qualified builder with an approved project.

---

## 3. THE PROJECT REQUIREMENT

The project is the core of the sprint. Without a validated project, there is no sprint seat.

### 3-1. What Makes a Good BSP Project

A valid BSP project has:
...
**Accessible data.** Before Day 1, you have confirmed access to every dataset the project needs. Sprint time is not spent waiting on permissions.

**TM-20/30 scope.** The work does not require writing Python, TypeScript, or OSDK integrations. If it does, you need TM-40 specialist training, not BSP.

**5-day feasibility.** A functional prototype can be built in five days. Not a complete production system — a functional prototype that demonstrates the solution and can be refined post-sprint.

### 3-2. Project Brief

Submit the Project Brief (Appendix A) to C2DAO through your Unit Training NCO/Officer at least 14 calendar days before sprint Day 1. The brief captures:
...
The handoff package is required. It is how the sprint product becomes a lasting asset.
...
Sprint products are subject to the same governance standards as any other Foundry product.
...
- [ ] Sprint workspace access provisioned and confirmed (log in and verify environment loads)
...
If any item is not complete 5 days before Day 1, contact C2DAO. Late access issues burn sprint time and affect other participants.
...
Sprint iteration: [Quarter/Year, e.g., Q2 FY26]
...
```
BUILDER SPRINT — HANDOFF PACKAGE
...
*Builder Sprint (BSP) Participant Guide | Version 1.0 | March 2026*
