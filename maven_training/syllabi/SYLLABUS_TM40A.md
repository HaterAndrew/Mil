# COURSE SYLLABUS
## TM-40A — OPERATIONS RESEARCH/SYSTEMS ANALYSIS (ORSA)
### Maven Smart System (MSS) — USAREUR-AF

| | |
|---|---|
| **Level** | TM-40A (ORSA Specialist Track) |
...
TM-40A does not teach statistics from scratch. It teaches you to apply your existing quantitative skills on MSS data, using Foundry Code Workspaces, and to deliver outputs that meet USAREUR-AF ORSA product standards.
...
- [ ] Read TM-40A, Chapter 1 (Introduction, role, prerequisites self-check) — 30 min
- [ ] Read TM-40A, Chapter 2, Sections 2-1 and 2-2 (Code Workspace overview) — 20 min
...
**Evening reading:** TM-40A, Chapter 3 (Statistical Modeling) — review regression and validation procedures.
...
**Evening reading:** TM-40A, Chapter 4 (Time Series) — review ARIMA procedures and confidence bound requirements; TM-40A, Chapter 5 (Monte Carlo) — review simulation framework.
...
**Evening reading:** TM-40A, Chapter 6 (Linear Programming) — review formulation and constraint documentation; TM-40A, Chapter 9 (Communicating Uncertainty) — read before the commander brief exercise on Day 5.
...
**Evening reading:** TM-40A, Chapter 9 (Communicating Uncertainty) — the briefing posture and what NOT to say sections. Review your full model output from this week — what would you brief to the G4?
...
| When | Reading |
|---|---|
| Before Day 1 | TM-40A, Ch 1 (Introduction/prereq self-check) |
| Before Day 1 | TM-40A, Ch 2 Sec 2-1/2-2 (Code Workspace overview) |
| Day 1 evening | TM-40A, Ch 3 (Statistical Modeling — regression/validation) |
| Day 2 evening | TM-40A, Ch 4 (Time Series — ARIMA/confidence bounds) |
| Day 2 evening | TM-40A, Ch 5 (Monte Carlo — simulation framework) |
| Day 3 evening | TM-40A, Ch 6 (Linear Programming — formulation) |
| Day 3 evening | TM-40A, Ch 9 (Communicating Uncertainty) |
| Day 4 evening | TM-40A, Ch 9 (re-read briefing posture sections) |
...
- Sensitivity analysis is consistently skipped in training due to time pressure. Read TM-40A, Chapter 5 before Day 3. The evaluator's questions on brief assumptions draw directly from it.

---

*USAREUR-AF Operational Data Team — UNCLASSIFIED*
*Syllabus TM-40A | Version 2.0 | March 2026*
