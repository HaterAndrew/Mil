# COURSE SYLLABUS
## TM-40I — MACHINE LEARNING ENGINEER
...
TM-40I focuses on the operational implementation of ML on MSS, not on ML theory. It assumes you already know how to train a model. What it teaches is how to do that inside the Foundry environment with the governance, monitoring, and documentation standards the Army requires.
...
- [ ] Read TM-40I, Chapter 1 (Introduction, role, prerequisites self-check) — 25 min
- [ ] Read TM-40I, Chapter 9 (Model Governance) — read this first. Understanding the governance destination makes the technical content purposeful.
...
**Evening reading:** TM-40I, Chapter 3 (Feature Engineering) — review the feature documentation standards.
...
| 1100–1115 | —  | Break    | |
| 1115–1200 | 7  | Lab      | Feature pipeline: leakage audit — verify no feature can be derived from the label; run leakage check procedure from TM-40I Chapter 3 |
| 1200–1300 | —  | Lunch    | |
...
**Evening reading:** TM-40I, Chapter 5 (Model Evaluation) — review acceptance thresholds and calibration requirements.
...
**Evening reading:** TM-40I, Chapter 7 (MLOps) — review drift detection patterns and alert configuration.
...
**Evening reading:** TM-40I, Chapter 9 (Model Governance) — re-read the model card requirements; draft your model governance document for the Day 5 evaluation before arriving.
...
| When | Reading |
|---|---|
| Before Day 1 | TM-40I, Ch 1 (Introduction/prereq self-check) |
| Before Day 1 | TM-40I, Ch 9 (Model Governance) — read first |
| Day 1 evening | TM-40I, Ch 3 (Feature Engineering — documentation standards) |
| Day 2 evening | TM-40I, Ch 5 (Model Evaluation — thresholds/calibration) |
| Day 3 evening | TM-40I, Ch 7 (MLOps — drift detection/alerting) |
| Day 4 evening | TM-40I, Ch 9 (re-read model card requirements; draft governance doc) |
...
7. Complete the model governance document (model card) meeting TM-40I Chapter 9 standards
...
*Syllabus TM-40I | Version 2.0 | March 2026*
