...
- [ ] Read TM-40J, Chapter 1 (Introduction) and complete the prerequisite check — 20 min
- [ ] Read TM-40J, Chapter 2 (Program Data Architecture) — the data model section before the Ontology lab
...
**Evening reading:** TM-40J, Chapter 3 (Milestone Tracking) — review the RAG computation logic; TM-40J, Chapter 4 (Resource and Budget) — review the obligation rate threshold table.
...
**Evening reading:** TM-40J, Chapters 5–8 (Portfolio, Pipelines, Commander Briefs, Governance) — reference read; walk through your Day 2 product against the PM Dashboard Standards Checklist before Day 3.
...
| When | Reading |
|---|---|
| Before Day 1 | TM-40J, Ch 1 (Introduction/prereq check) |
| Before Day 1 | TM-40J, Ch 2 (Program Data Architecture) |
| Day 1 evening | TM-40J, Ch 3 (Milestone Tracking — RAG logic) |
| Day 1 evening | TM-40J, Ch 4 (Resource/Budget — threshold table) |
| Day 2 evening | TM-40J, Chs 5–8 (reference read; walk product against checklist) |
...
*Syllabus TM-40J | Version 2.0 | March 2026*
