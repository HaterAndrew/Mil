...
| | |
|---|---|
| **Level** | TM-40E (Knowledge Manager Specialist Track) |
...
7. Build a PCS knowledge transfer package for a specific role using TM-40E Chapter 9 procedures — specific to the Foundry project, Object Types, pipelines, and contacts
...
- [ ] Read TM-40E, Chapter 1 (Introduction, Safety Summary) — 25 min
- [ ] Read TM-40E, Chapter 2 (Knowledge Architecture Design) — domain analysis and Object Type design sections
...
**Evening reading:** TM-40E, Chapter 3 (AAR Capture) — review the form validation logic; TM-40E, Chapter 5 (AIP-Assisted Knowledge Work) — read the WARNING on AIP output review requirements.
...
| 1030–1045 | —  | Break    | |
| 1045–1200 | 7  | Lab      | SOP/doctrine version control: lifecycle management, version tagging, SOP review notification workflow (TM-40E Section 7-6 procedures) |
| 1200–1300 | —  | Lunch    | |
| 1300–1400 | 8  | Lab      | Personnel expertise mapping: ExpertiseProfile Object Type, skills taxonomy design, SME directory application; Privacy Act authorities (TM-40E Section 8-1) |
| 1400–1415 | —  | Break    | |
...
**Evening reading:** TM-40E, Chapter 9 (Knowledge Transfer and Continuity) — read in full; TM-40E, Section 5-3 (AIP prompt template) — start from the template and document your modifications.
...
| 0830–1045 | 11 | Lab      | **PCS package draft review:** each trainee presents draft PCS transfer package to instructor; instructor reviews against TM-40E Chapter 9 completeness criteria; trainees revise based on feedback |
| 1045–1100 | —  | Break    | |
...
| When | Reading |
|---|---|
| Before Day 1 | TM-40E, Ch 1 (Introduction/Safety) |
| Before Day 1 | TM-40E, Ch 2 (Knowledge Architecture Design) |
| Day 1 evening | TM-40E, Ch 3 (AAR Capture — validation logic) |
| Day 1 evening | TM-40E, Ch 5 (AIP — WARNING on review requirements) |
| Day 2 evening | TM-40E, Ch 9 (Knowledge Transfer/Continuity) |
| Day 2 evening | TM-40E, Section 5-3 (AIP prompt template) |
...
**Go standard:** Pass 5 of 6 tasks. AIP workflow has a documented, tested human review gate — no AIP output auto-publishes (hard No-Go if violated). PCS package reviewed by instructor against TM-40E Chapter 9 completeness criteria.
...
- The AIP summarization prompt matters more than the workflow configuration. A poorly-written prompt produces garbage summaries that flood the review queue as noise — technically compliant, operationally useless. Spend time on the prompt during Day 2's prompt iteration lab. TM-40E Section 5-3 has the recommended template — start there and modify.
...
- Privacy Act applies to ExpertiseProfile data. The evaluator will ask what Privacy Act authorities cover your skills database. The answer is in TM-40E Section 8-1. Read it before Day 2.
...
*Syllabus TM-40E | Version 2.0 | March 2026*
