...
TM-40L is for developers who need to go beyond the MSS UI. If Workshop and Pipeline Builder can do what you need, TM-30 is sufficient. TM-40L is for building applications, automations, and integrations that the UI tools cannot deliver.
