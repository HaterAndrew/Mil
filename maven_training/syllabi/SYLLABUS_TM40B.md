...
| | |
|---|---|
| **Level** | TM-40B (AI Engineer Specialist Track) |
...
- [ ] Read TM-40B, Chapter 1 (Introduction) — full read, 30 min (**required, not optional**)
- [ ] Read TM-40B, Chapter 6, Sections 6-1 and 6-2 (AI Safety) — read before the safety block, not after
- [ ] Read TM-40B, Appendix B (Prohibited AI Use Cases) — memorize the prohibited list
...
**Evening reading:** TM-40B, Chapter 3 (AIP Logic) — skim the workflow authoring procedures; Chapter 6 Sections 6-3/6-4 (OPSEC for AI outputs).
...
**Evening reading:** TM-40B, Chapter 5 (LLM Integration Patterns) — focus on RAG architecture section.
...
**Evening reading:** TM-40B, Appendix A (AIP Authorization Checklist) — read in full; you will complete this on Day 4/5.
...
| 1500–1515 | —  | Break    | |
| 1515–1700 | 16 | Lab      | Applying the AI Output Validation Framework (TM-40B, Appendix C); completing the AIP Authorization Checklist for a practice workflow |
...
| When | Reading |
|---|---|
| Before Day 1 (**required**) | TM-40B, Ch 1 (Introduction) |
| Before Day 1 (**required**) | TM-40B, Ch 6 Sec 6-1/6-2 (AI Safety) |
| Before Day 1 (**required**) | TM-40B, Appendix B (Prohibited Use Cases) |
| Day 1 evening | TM-40B, Ch 3 (AIP Logic workflow authoring) |
| Day 1 evening | TM-40B, Ch 6 Sec 6-3/6-4 (OPSEC for AI) |
| Day 2 evening | TM-40B, Ch 5 (LLM Integration Patterns — RAG) |
| Day 3 evening | TM-40B, Appendix A (Authorization Checklist) |
...
*Syllabus TM-40B | Version 2.0 | March 2026*
