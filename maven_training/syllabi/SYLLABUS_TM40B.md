# COURSE SYLLABUS — SL 4B: FIRES WARFIGHTING FUNCTION
## Maven Smart System (MSS) — USAREUR-AF

| Field | Detail |
|---|---|
| **Level** | SL 4B — Fires WFF Track |
| **Duration** | 3 days (24 hours) |
| **Prerequisites** | SL 1, SL 2, SL 3 (Go evaluations on file); CONCEPTS_GUIDE_TM40B_FIRES (required reading before Day 1) |
...
**BLUF:** SL 4B teaches fires staff to integrate MSS into fires and targeting workflows — configuring FSCMs on the COP, managing targeting data, building effects assessment dashboards, and supporting BDA workflows. Course applies MSS capabilities to processes in FM 3-09, ATP 3-09.42, and FM 3-60. No coding or pipeline experience required.
...
| Item | Reference |
|---|---|
| **Practical Exercise** | EX_40B (EXERCISE.md + ENVIRONMENT_SETUP.md) — `exercises/EX_40B_fires/` |
...
SL 4B is one of six WFF tracks. All require SL 1, SL 2, and SL 3 as prerequisites.
...
*Syllabus SL 4B | Version 1.0 | March 2026*
