...
SAMPLE_PACKAGES = [
    ...
    {
        "selected_tms": ["SL 4A", "SL 4B", "SL 4C"],
        "all_tms": ["SL 1", "SL 2", "SL 3", "SL 4A", "SL 4B", "SL 4C"],
        "total_items": 92,
        "size_kb": 5400,
        "include_pdfs": True,
    ...
    {
        "selected_tms": ["SL 4G", "SL 4H"],
        "all_tms": ["SL 1", "SL 2", "SL 3", "SL 4G", "SL 4H"],
        "total_items": 78,
        "size_kb": 4200,
        "include_pdfs": False,
    ...
    {
        "selected_tms": ["SL 5G"],
        "all_tms": ["SL 1", "SL 2", "SL 3", "SL 4G", "SL 5G"],
        "total_items": 85,
        "size_kb": 4800,
        "include_pdfs": True,
