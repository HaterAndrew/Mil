...
COURSES = [
    # ── Tier 1: Foundation ──
    {
        ...
        "instructor_qualification": "SL 2 certified; 90 days active MSS use",
    ...
    # ── Tier 2: Builder ──
    {
        ...
        "duration_hours": 40,
        "prerequisites": ["SL 1"],
        "prerequisite_description": "SL 1 Go on file",
        ...
        "instructor_qualification": "SL 3 certified; 6+ months Foundry build experience; able to troubleshoot all SL 2 labs",
    ...
    # ── Tier 3: Advanced Builder ──
    {
        ...
        "duration_days": 5,
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2"],
        "prerequisite_description": "SL 1 and SL 2 Go on file",
        ...
        "instructor_qualification": "SL 4 (any track) or C2DAO SME designation; able to conduct design critiques",
    ...
    # ── Tier 4a: WFF Functional Tracks ──
    {
        ...
        "duration_days": 3,
        "duration_hours": 24,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, and SL 3 Go on file (all required)",
        ...
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4A certified; G2/S2 Intel functional background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
    ...
    },
    {
        ...
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4B certified; Fires/FSCOORD functional background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
        "evaluation_type": "Practical exercise (GO/NO-GO)",
        "evaluation_hours": 3.0,
    ...
    },
    {
        ...
        "cadence": "Quarterly or as-needed",
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4C certified; G3/S3 movement and maneuver background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
        "evaluation_type": "Practical exercise (GO/NO-GO)",
        "evaluation_hours": 3.0,
    ...
    },
    {
        ...
        "cadence": "Quarterly or as-needed",
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4D certified; G4/S4 sustainment background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
        "evaluation_type": "Practical exercise (GO/NO-GO)",
        "evaluation_hours": 3.0,
    ...
    },
    {
        ...
        "cadence": "Quarterly or as-needed",
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4E certified; Protection functional background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
        "evaluation_type": "Practical exercise (GO/NO-GO)",
        "evaluation_hours": 3.0,
    ...
    },
    {
        ...
        "cadence": "Quarterly or as-needed",
        "instructor_ratio": "8:1",
        "instructor_qualification": "SL 4F certified; Mission Command/G6 background; SL 3 proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
        "evaluation_type": "Practical exercise (GO/NO-GO)",
        "evaluation_hours": 3.0,
    ...
    # ── Tier 4b: Specialist Tracks ──
    {
        ...
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, SL 3 Go on file (all required); quantitative background (statistics, linear algebra); Python or R proficiency",
        ...
        "instructor_qualification": "FA49 or equivalent ORSA background; SL 4G certified or C2DAO SME designation",
    ...
    },
    {
        ...
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, SL 3 Go on file (all required); Python proficiency; Data Literacy Technical Reference read",
        ...
        "cadence": "Semi-annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "AIP Logic authoring experience; C2DAO AI SME designation; SL 4H certified",
    ...
    },
    {
        ...
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, SL 3 Go on file (all required); Python proficiency (pandas, scikit-learn, PyTorch or equivalent)",
        ...
        "cadence": "Semi-annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "ML production experience; SL 4M certified; C2DAO MLE SME designation",
    ...
    },
    {
        ...
        "duration_hours": 32,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, SL 3 Go on file (all required)",
        ...
        "cadence": "Quarterly",
        "instructor_ratio": "6:1",
        "instructor_qualification": "Program management background; SL 3 certified; GFEBS/IMS proficiency",
        "access_level": "Builder",
        "provisioning_lead_days": 5,
    ...
    },
    {
        ...
        "cadence": "Quarterly",
        "instructor_ratio": "6:1",
        "instructor_qualification": "Knowledge management background; SL 3 certified; AIP Logic configuration proficiency",
    ...
    },
    {
        ...
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3"],
        "prerequisite_description": "SL 1, SL 2, SL 3 Go on file (all required); TypeScript or Python proficiency; REST API familiarity",
        ...
        "cadence": "Semi-annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "Software engineering background; OSDK/Platform SDK proficiency; SL 4L certified",
    ...
    # ── Tier 5: Advanced Specialist ──
    {
        ...
        "duration_days": 5,
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4G"],
        "prerequisite_description": "SL 4G Go on file (required); active ORSA role at theater level",
        ...
        "instructor_ratio": "4:1",
        "instructor_qualification": "FA49 O-4+ or equivalent; SL 5G certified or C2DAO Advanced ORSA SME; active analytical practice at theater level",
    ...
    },
    {
        ...
        "duration_days": 5,
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4H"],
        "prerequisite_description": "SL 4H Go on file (required)",
        ...
        "cadence": "Annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "SL 5H certified or C2DAO Advanced AI SME; production AIP/Agent Studio experience",
    ...
    },
    {
        ...
        "duration_days": 5,
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4M"],
        "prerequisite_description": "SL 4M Go on file (required)",
        ...
        "cadence": "Annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "SL 5M certified or C2DAO Advanced MLE SME; production ML pipeline experience",
    ...
    },
    {
        ...
        "duration_days": 3,
        "duration_hours": 24,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4J"],
        "prerequisite_description": "SL 4J Go on file (required)",
        ...
        "cadence": "Annual or on demand",
        "instructor_ratio": "6:1",
        "instructor_qualification": "SL 5J certified or C2DAO Advanced PM SME; enterprise portfolio management experience",
    ...
    },
    {
        ...
        "duration_days": 3,
        "duration_hours": 24,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4K"],
        "prerequisite_description": "SL 4K Go on file (required)",
        ...
        "cadence": "Annual or on demand",
        "instructor_ratio": "6:1",
        "instructor_qualification": "SL 5K certified or C2DAO Advanced KM SME; enterprise KM architecture experience",
    ...
    },
    {
        ...
        "duration_days": 5,
        "duration_hours": 40,
        "prerequisites": ["SL 1", "SL 2", "SL 3", "SL 4L"],
        "prerequisite_description": "SL 4L Go on file (required)",
        ...
        "cadence": "Annual or on demand",
        "instructor_ratio": "4:1",
        "instructor_qualification": "SL 5L certified or C2DAO Advanced SWE SME; production Foundry integration experience",
...
def build_json(out_path: Path):
    ...
    packet = {
        ...
        "courses": COURSES,
        "prerequisite_chain": {
            "description": "SL 1 → SL 2 → SL 3 → ALL SL 4 (A-M) → SL 5 (G-M only)",
            "tree": {
                "SL 1": {
                    "SL 2": {
                        "SL 3": {
...
def _blocks_table(c: dict) -> str:
    ...
    if not c["blocks"]:
        return "> *Detailed block-of-instruction tables are maintained in the applicable Lesson Plan Outlines and Syllabus. See WFF Lesson Plan Outlines (SL 4A–F) or SL 5 Advanced Lesson Plan Outlines.*\n"
    lines = [
