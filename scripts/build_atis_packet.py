...
# ── Course definitions ────────────────────────────────────────────────────────
# Master course registry — single source of truth for all 24 courses + BSP.
...
COURSES = [
    ...
    # ── Tier 4a: WFF Functional Tracks ──
    {
        ...
        "security_clearance": "None required (UNCLASSIFIED training environment)",
        "hours_by_method": {
            "lecture_brief": 1.0,
            "lab": 15.0,
            "discussion_review": 1.0,
...
METHOD_CODES = {
    ...
    "SPRINT": "Builder Sprint (self-directed applied build)",
}
