...
DEFAULT_FEATURE_MAP = {
    "pipeline builder": ["SL 2", "SL 3"],
    "pipeline": ["SL 2", "SL 3", "SL 4L"],
    "ontology": ["SL 2", "SL 3", "SL 4K"],
    "workshop": ["SL 1", "SL 2", "SL 3"],
    "aip logic": ["SL 3"],
    "aip": ["SL 3", "SL 4H"],
    "agent studio": ["SL 3", "SL 4H"],
    "quiver": ["SL 2", "SL 3"],
    "contour": ["SL 2", "SL 3"],
    "code repositories": ["SL 4L", "SL 4O"],
    "code workbook": ["SL 4G", "SL 4L", "SL 4M"],
    "foundry ml": ["SL 4M", "SL 5M"],
    "model studio": ["SL 4M", "SL 5M"],
    "actions": ["SL 2", "SL 3"],
    "object type": ["SL 2", "SL 3"],
    "object views": ["SL 2", "SL 3"],
    "writeback": ["SL 2", "SL 3"],
    "automations": ["SL 3"],
    "autopilot": ["SL 3"],
    "machinery": ["SL 3"],
    "data connection": ["SL 4O"],
    "data integration": ["SL 4O"],
    "magritte": ["SL 4O"],
    "slate": ["SL 4L", "SL 4N"],
    "osdk": ["SL 4L", "SL 5L"],
    "developer console": ["SL 4L", "SL 4O"],
    "third-party": ["SL 4O"],
    "security": ["SL 1", "SL 3"],
    "markings": ["SL 1", "SL 3"],
    "permissions": ["SL 1", "SL 3"],
    "sensitive data": ["SL 1", "SL 3"],
    "gaia": ["SL 1"],
    "compass": ["SL 1"],
    "workflow lineage": ["SL 3", "SL 4J"],
    "scheduling": ["SL 4J"],
    "ci/cd": ["SL 4O", "SL 5O"],
    "compute module": ["SL 4O", "SL 5O"],
    "webhook": ["SL 4O"],
    "data health": ["SL 3"],
    "data quality": ["SL 3", "SL 4G"],
    "typeclass": ["SL 3"],
    "interface": ["SL 3"],
    "transforms": ["SL 4L", "SL 4O"],
    "functions": ["SL 4L"],
    "foundry branching": ["SL 2", "SL 3"],
    "marketplace": ["SL 4L", "SL 4O"],
    "document intelligence": ["SL 4H", "SL 4K"],
    "notepad": ["SL 1", "SL 2"],
}
