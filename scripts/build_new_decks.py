...
def deck_wff_overview():
    build_deck(
        ...
        header_text="HOW MSS SUPPORTS WARFIGHTING FUNCTIONS  ·  TM-40 WFF",
        slides_content=[
            ("THE SIX WARFIGHTING FUNCTIONS AND MSS", [
                "MSS is not a single-function tool — it is the common data layer for all six WFFs",
                "Each WFF has its own TM-40 track (A–F) with doctrine-aligned workflows",
                "▶ Warfighting Function Tracks",
                "  TM-40A — Intelligence (IPOE, all-source analysis, targeting)",
                "  TM-40B — Fires (D3A, FSC, AMD, C-RAM, joint fires)",
                "  TM-40C — Movement & Maneuver (MDMP, routes, force tracking)",
                "  TM-40D — Sustainment (supply chain, maintenance, transport)",
                "  TM-40E — Protection (CRM, CBRN, AT/FP, survivability)",
                "  TM-40F — Mission Command (battle rhythm, COP, CCIR, staff integration)",
                "▶ Prerequisite: TM-30 (Advanced Builder) required for all WFF tracks",
            ]),
            ("INTELLIGENCE (TM-40A) — IPOE AND ANALYSIS IN MSS", [
                "▶ Core Functions",
            ...
            ("FIRES (TM-40B) — TARGETING AND FIRE SUPPORT IN MSS", [
                "▶ Core Functions",
            ...
            ("MOVEMENT & MANEUVER (TM-40C) — OPERATIONS IN MSS", [
            ...
            ("SUSTAINMENT (TM-40D) — LOGISTICS IN MSS", [
                "▶ Supply Chain",
            ...
            ("PROTECTION (TM-40E) — CRM AND FORCE PROTECTION IN MSS", [
            ...
            ("MISSION COMMAND (TM-40F) — STAFF INTEGRATION IN MSS", [
                "▶ Staff Section Integration",
                "  S1–S6/G1–G6 role-specific MSS workflows defined in TM-40F",
            ...
            ("CROSS-WFF DATA FLOWS AND DECISION ADVANTAGE", [
                ...
                "  TM-40F ties all five WFFs into a coherent COP and battle rhythm",
            ...
            ("WFF TRACK ENROLLMENT AND PREREQUISITES", [
                ...
                "  TM-10 → TM-20 → TM-30 → TM-40 (WFF track)",
                "  No direct enrollment into TM-40A–F without TM-30 completion",
                "▶ WFF track selection: based on duty position and MOS",
                "  S2/G2 / 35-series → TM-40A (Intelligence)",
                "  FA / 13-series / 14-series → TM-40B (Fires)",
                "  S3/G3 / 11-series / 19-series / 12-series / 15-series → TM-40C (M&M)",
                "  S4/G4 / 90-series / 91-series / 92-series / 88-series → TM-40D (Sustainment)",
    ...
    build_deck(
        ...
        slides_content=[
            ("THE MLE ROLE IN USAREUR-AF", [
                ...
                "  MLE does NOT author AIP Logic workflows — that is TM-40H (AI Engineer)",
                "▶ Where MLE Sits in the Data Chain",
                "  Downstream of data engineers (Pipeline Builder, TM-20/30)",
            ...
            ("MLE ROLE BOUNDARIES AND CROSS-TRACK COORDINATION", [
                ...
                "▶ MLE vs. Software Engineer (TM-40L)",
...
def deck_tm40j():
    build_deck(
        ...
        title_lines=["DATA PROGRAM MANAGER ESSENTIALS",
                     "TM-40J  ·  Specialist Track  ·  Prereq: TM-30"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="DATA PROGRAM MANAGER ESSENTIALS  ·  TM-40J  ·  Specialist",
        slides_content=[
            ("THE TECHNICAL PM ROLE IN THE MSS ECOSYSTEM", [
                "The TM-40J PM translates between technical teams and operational stakeholders",
                ...
                "  Do not make technical architecture decisions (that is TM-40L/H/I)",
                ...
                "▶ Curriculum Position: TM-40J after TM-30; advanced track is TM-50J",
            ]),
            ...
            ("TM-40J CURRICULUM OVERVIEW AND NEXT STEPS", [
                "▶ TM-40J Chapter Structure",
                ...
                "  Glossary",
                "▶ TM-40J is the only management-track specialist publication",
                "  Cross-track coordination: works with TM-40G, H, I, K, L daily",
                "▶ Next Steps: Complete TM-40J → eligible for TM-50J (Advanced Program Manager)",
            ]),
        ]
    )
...
def deck_tm50_overview():
    build_deck(
        ...
        title_lines=["ADVANCED MSS LEADERSHIP",
                     "TM-50 Series  ·  Platform Leadership  ·  Prereq: TM-40 (track-specific)"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED MSS LEADERSHIP  ·  TM-50 OVERVIEW",
        slides_content=[
            ("WHAT CHANGES AT TM-50", [
                "TM-50 is not a continuation of TM-40 tasks — it is a change of role",
                "▶ TM-40: Practitioner",
                ...
                "  TM-50 practitioners spend less time writing code and more time reviewing it",
                "  Less feature engineering; more feature store architecture",
                "  Less sprint planning; more program increment planning",
                "▶ Prerequisite: each TM-50 track requires its corresponding TM-40 track",
            ]),
            ("THE SIX TM-50 SPECIALIST TRACKS", [
            ...
            ("PLATFORM LEADERSHIP RESPONSIBILITIES", [
                "All TM-50 practitioners share a common set of platform leadership duties:",
                "▶ Architecture Governance",
                "  Review designs proposed by TM-40 practitioners",
                ...
                "  Structured code review and design review for TM-40 practitioners",
                "  Succession planning: document institutional knowledge before rotation",
                "▶ Cross-Track Integration",
                "  TM-50 practitioners coordinate across all TM-50 tracks",
            ...
            ("ENTERPRISE RISK AND COMPLIANCE AT TM-50", [
                "▶ Policy Framework (common across all TM-50 tracks)",
                ...
                "  TM-50L owns ATO support documentation for platform components",
                "  TM-50H/I own model-level risk documentation (RAIMTF)",
                "  TM-50J owns program-level governance and policy compliance framework",
                "▶ Institutional Memory Risk",
                "  At TM-50, you hold disproportionate institutional knowledge",
            ...
            ("TM-50 TRACK SELECTION AND ENROLLMENT", [
                ...
                "▶ Who Should Enroll in TM-50",
                "  Personnel who will lead a platform domain (not just contribute to it)",
                "  Personnel who supervise TM-40 practitioners",
                ...
                "▶ TM-50 is not a competition — it is a responsibility assignment",
            ]),
            ("CROSS-TRACK TM-50 INTEGRATION", [
                "At enterprise scale, TM-50 tracks must coordinate as a leadership team:",
                "▶ TM-50L + TM-50H/I — Platform and AI/ML Alignment",
                "  SWE provides the platform; AI/ML operates on it",
                "  Shared Feature Store design, inference endpoint architecture, CI/CD pipeline",
                "▶ TM-50G + TM-50H/I — ORSA and AI/ML Integration",
                ...
                "▶ TM-50K + All Tracks — Knowledge Architecture",
                "  KM owns the ontology and knowledge graph that all tracks depend on",
                "  Ontology changes require TM-50K review before implementation",
                "▶ TM-50J — Program Integration Authority",
                "  PM is the integration point for all TM-50 domains",
                "  Dependency management, portfolio visibility, and commander reporting are PM-owned",
                "▶ Monthly TM-50 leadership sync recommended: dependency review + risk escalation",
            ]),
            ("FROM TM-40 TO TM-50 — THE READINESS CHECKLIST", [
                "Before enrolling in TM-50, practitioners should be able to:",
                "▶ Technical Readiness",
                "  Independently complete all TM-40 tasks without reference to the manual",
                "  Have reviewed the work of at least one other TM-40 practitioner",
                ...
                "  TM-50 enrollment without readiness wastes institutional capacity",
            ]),
        ]
    )
...
def deck_tm50g():
    build_deck(
        ...
        title_lines=["ADVANCED ORSA: THEATER-LEVEL ANALYSIS",
                     "TM-50G  ·  Advanced Specialist  ·  Prereq: TM-40G"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED ORSA  ·  TM-50G  ·  Advanced Specialist",
        slides_content=[
            ("FROM TM-40G TO TM-50G — SCOPE CHANGE", [
                "▶ TM-40G (ORSA): Practitioner",
                "  Statistical modeling, time series, Monte Carlo, code workspaces",
                "  Products for brigade/division-level commanders",
                "▶ TM-50G (Advanced ORSA): Platform Leader",
...
def deck_tm50h():
    build_deck(
        ...
        title_lines=["ADVANCED AI ENGINEERING",
                     "TM-50H  ·  Advanced Specialist  ·  Prereq: TM-40H"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED AI ENGINEERING  ·  TM-50H  ·  Advanced Specialist",
        slides_content=[
            ("FROM TM-40H TO TM-50H — SCOPE CHANGE", [
                "▶ TM-40H (AI Engineer): Practitioner",
                "  Build AIP Logic workflows, Agent Studio agents, single-system RAG pipelines",
                "  Scope: individual AI applications",
                "▶ TM-50H (Advanced AI Engineer): Platform Leader",
            ...
            ("PRODUCTION AI OBSERVABILITY (CHAPTER 6)", [
                ...
                "  Alerts: output quality below threshold triggers TM-50H review",
            ...
            ("ENTERPRISE AI ARCHITECTURE AND GOVERNANCE (CHAPTER 8)", [
                ...
                "  Any new AI system requires TM-50H architecture review before build",
                ...
                "  TM-50H is the compliance point for AI systems — not legal, not compliance office",
                ...
                "  TM-50H chairs PRR before any AI system goes to production",
...
def deck_tm50j():
    build_deck(
        ...
        title_lines=["ADVANCED PROGRAM MANAGEMENT",
                     "TM-50J  ·  Advanced Specialist  ·  Prereq: TM-40J"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED PROGRAM MANAGEMENT  ·  TM-50J  ·  Advanced Specialist",
        slides_content=[
            ("FROM TM-40J TO TM-50J — SCOPE CHANGE", [
                "▶ TM-40J (PM): Manage one data/AI project team",
                "▶ TM-50J (Advanced PM): Manage a portfolio of concurrent data/AI programs",
            ...
            ("PORTFOLIO-LEVEL TRACKING AND THEATER VISIBILITY (CHAPTER 3)", [
                "▶ Why Portfolio Tracking at TM-50J Level",
            ...
            ("VENDOR AND CONTRACTOR MANAGEMENT (CHAPTER 7)", [
                ...
                "  TM-50J PM manages task order scope, deliverables, and acceptance criteria",
...
def deck_tm50k():
    build_deck(
        ...
        title_lines=["ADVANCED KNOWLEDGE MANAGEMENT",
                     "TM-50K  ·  Advanced Specialist  ·  Prereq: TM-40K"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED KNOWLEDGE MANAGEMENT  ·  TM-50K  ·  Advanced Specialist",
        slides_content=[
            ("FROM TM-40K TO TM-50K — ARCHITECT, NOT OPERATOR", [
                "▶ TM-40K: Operate and maintain knowledge architecture within a unit",
                "▶ TM-50K: Design the architecture that units operate within",
            ...
            ("ENTERPRISE KM ARCHITECTURE — CORPS/THEATER LEVEL (CHAPTER 2)", [
                ...
                "  KM Architecture Review Board: corps G6 + TM-50K leads + C2DAO representative",
            ]),
            ("CROSS-DOMAIN KNOWLEDGE FEDERATION (CHAPTER 3)", [
                ...
                "  Each directorate (G2, G3, G4, G6) has a KM domain — TM-50K coordinates",
                "  Cross-directorate links: TM-50K designs the bridge between domains",
            ...
            ("COALITION KNOWLEDGE SHARING (CHAPTER 5)", [
                ...
                "  No sharing without written authorization — TM-50K knows the boundary",
                "▶ NATO Knowledge Management Integration",
                "  STANAG 4778: NATO standard for lessons learned systems",
                "  TM-50K designs MSS-STANAG 4778 conformance mapping",
                ...
                "  Pull pattern: partner uploads to shared workspace, TM-50K reviews and integrates",
...
def deck_tm50l():
    build_deck(
        ...
        title_lines=["ADVANCED SOFTWARE ENGINEERING",
                     "TM-50L  ·  Advanced Specialist  ·  Prereq: TM-40L"],
        poc="USAREUR-AF  ·  C2DAO  ·  MSS",
        header_text="ADVANCED SOFTWARE ENGINEERING  ·  TM-50L  ·  Advanced Specialist",
        slides_content=[
            ("FROM TM-40L TO TM-50L — SCOPE CHANGE", [
                "▶ TM-40L: Build OSDK applications and Foundry integrations as a practitioner",
                "▶ TM-50L: Own the platform architecture that practitioners build on",
            ...
            ("PLATFORM SDK — INFRASTRUCTURE-LEVEL INTEGRATION (CHAPTER 2)", [
                ...
                "  OSDK (TM-40L): query ontology objects and execute actions via API",
                "  Platform SDK (TM-50L): manage datasets, branches, file resources at infrastructure level",
            ...
            ("HIGH-PERFORMANCE FOUNDRY DEVELOPMENT (CHAPTER 3)", [
                ...
                "  Compute cost reported monthly; TM-50L reviews unexplained cost increases",
            ]),
            ("MULTI-TENANT ARCHITECTURE AND CLASSIFICATION-AWARE DESIGN (CHAPTER 4)", [
                ...
                "  Aggregation risk: TM-50L reviews any feature that combines data across classifications",
            ...
            ("SECURITY ASSESSMENT AND SECURE CODE REVIEW (CHAPTER 7)", [
                ...
                "  TM-50L supports pentest scoping and reviews findings report",
            ]),
            ("PLATFORM LEADERSHIP AND ATO SUPPORT (CHAPTER 8)", [
                "▶ Architecture Review",
                "  TM-50L reviews all new application architectures before build begins",
                ...
                "  Every production code change reviewed by TM-50L or designated reviewer",
                ...
                "  Pair programming: TM-50L pairs with new TM-40L practitioners on first deployment",
                "▶ ATO Support Documentation",
                "  TM-50L owns: system architecture diagram, data flow diagrams, security controls",
