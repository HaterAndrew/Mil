...
PUB_TYPES = {
    "TM_EXEC":      ("TECHNICAL MANUAL",                    "EXEC"),
    # T3_I and T3_F defined in Train-the-Trainer section below
    "TM_10":        ("TECHNICAL MANUAL",                    "SL 1"),
    "TM_20":        ("TECHNICAL MANUAL",                    "SL 2"),
    "TM_30":        ("TECHNICAL MANUAL",                    "SL 3"),
    # WFF tracks (A–F, operational)
    "TM_40A":       ("TECHNICAL MANUAL",                    "SL 4A"),
    "TM_40B":       ("TECHNICAL MANUAL",                    "SL 4B"),
    "TM_40C":       ("TECHNICAL MANUAL",                    "SL 4C"),
    "TM_40D":       ("TECHNICAL MANUAL",                    "SL 4D"),
    "TM_40E":       ("TECHNICAL MANUAL",                    "SL 4E"),
    "TM_40F":       ("TECHNICAL MANUAL",                    "SL 4F"),
    # Technical specialist tracks (G–M)
    "TM_40G":       ("TECHNICAL MANUAL",                    "SL 4G"),
    "TM_40H":       ("TECHNICAL MANUAL",                    "SL 4H"),
    "TM_40M":       ("TECHNICAL MANUAL",                    "SL 4M"),
    "TM_40J":       ("TECHNICAL MANUAL",                    "SL 4J"),
    "TM_40K":       ("TECHNICAL MANUAL",                    "SL 4K"),
    "TM_40L":       ("TECHNICAL MANUAL",                    "SL 4L"),
    "TM_40N":       ("TECHNICAL MANUAL",                    "SL 4N"),
    "TM_40O":       ("TECHNICAL MANUAL",                    "SL 4O"),
    # Technical specialist advanced tracks (50G–O)
    "TM_50G":       ("TECHNICAL MANUAL",                    "SL 5G"),
    "TM_50H":       ("TECHNICAL MANUAL",                    "SL 5H"),
    "TM_50M":       ("TECHNICAL MANUAL",                    "SL 5M"),
    "TM_50J":       ("TECHNICAL MANUAL",                    "SL 5J"),
    "TM_50K":       ("TECHNICAL MANUAL",                    "SL 5K"),
    "TM_50L":       ("TECHNICAL MANUAL",                    "SL 5L"),
    "TM_50N":       ("TECHNICAL MANUAL",                    "SL 5N"),
    "TM_50O":       ("TECHNICAL MANUAL",                    "SL 5O"),
    ...
    "TM10_LESSON":       ("LESSON PLANS",                        "SL 1"),
    "TM20_LESSON":       ("LESSON PLANS",                        "SL 2"),
    "TM30_LESSON":       ("LESSON PLANS",                        "SL 3"),
    "TM_40_OVERVIEW":    ("SPECIALIST TRACK OVERVIEW",            "SL 4"),
    "TM_50_OVERVIEW":    ("ADVANCED TRACK OVERVIEW",              "SL 5"),
    "TM40_SPECIALIST":   ("LESSON PLANS",                        "SL 4"),
    "CONCEPTS_GUIDE_TM_EXEC": ("CONCEPTS GUIDE",                  "EXEC"),
    # CONCEPTS_GUIDE_T3I and CONCEPTS_GUIDE_T3F defined in Train-the-Trainer section below
    "CONCEPTS_GUIDE_TM40A": ("CONCEPTS GUIDE",                   "SL 4A"),
    "CONCEPTS_GUIDE_TM40B": ("CONCEPTS GUIDE",                   "SL 4B"),
    "CONCEPTS_GUIDE_TM40C": ("CONCEPTS GUIDE",                   "SL 4C"),
    "CONCEPTS_GUIDE_TM40D": ("CONCEPTS GUIDE",                   "SL 4D"),
    "CONCEPTS_GUIDE_TM40E": ("CONCEPTS GUIDE",                   "SL 4E"),
    "CONCEPTS_GUIDE_TM40F": ("CONCEPTS GUIDE",                   "SL 4F"),
    "CONCEPTS_GUIDE_TM40G": ("CONCEPTS GUIDE",                   "SL 4G"),
    "CONCEPTS_GUIDE_TM40H": ("CONCEPTS GUIDE",                   "SL 4H"),
    "CONCEPTS_GUIDE_TM40M": ("CONCEPTS GUIDE",                   "SL 4M"),
    "CONCEPTS_GUIDE_TM40J": ("CONCEPTS GUIDE",                   "SL 4J"),
    "CONCEPTS_GUIDE_TM40K": ("CONCEPTS GUIDE",                   "SL 4K"),
    "CONCEPTS_GUIDE_TM40L": ("CONCEPTS GUIDE",                   "SL 4L"),
    "CONCEPTS_GUIDE_TM40N": ("CONCEPTS GUIDE",                   "SL 4N"),
    "CONCEPTS_GUIDE_TM40O": ("CONCEPTS GUIDE",                   "SL 4O"),
    "CONCEPTS_GUIDE_TM50G": ("CONCEPTS GUIDE",                   "SL 5G"),
    "CONCEPTS_GUIDE_TM50H": ("CONCEPTS GUIDE",                   "SL 5H"),
    "CONCEPTS_GUIDE_TM50M": ("CONCEPTS GUIDE",                   "SL 5M"),
    "CONCEPTS_GUIDE_TM50J": ("CONCEPTS GUIDE",                   "SL 5J"),
    "CONCEPTS_GUIDE_TM50K": ("CONCEPTS GUIDE",                   "SL 5K"),
    "CONCEPTS_GUIDE_TM50L": ("CONCEPTS GUIDE",                   "SL 5L"),
    "CONCEPTS_GUIDE_TM50N": ("CONCEPTS GUIDE",                   "SL 5N"),
    "CONCEPTS_GUIDE_TM50O": ("CONCEPTS GUIDE",                   "SL 5O"),
    "SYLLABUS_TM_EXEC":  ("COURSE SYLLABUS",                     "EXEC"),
    # SYLLABUS_T3I and SYLLABUS_T3F defined in Train-the-Trainer section below
    "SYLLABUS_TM10":     ("COURSE SYLLABUS",                     "SL 1"),
    "SYLLABUS_TM20":     ("COURSE SYLLABUS",                     "SL 2"),
    "SYLLABUS_TM30":     ("COURSE SYLLABUS",                     "SL 3"),
    "SYLLABUS_TM40G":    ("COURSE SYLLABUS",                     "SL 4G"),
    "SYLLABUS_TM40H":    ("COURSE SYLLABUS",                     "SL 4H"),
    "SYLLABUS_TM40M":    ("COURSE SYLLABUS",                     "SL 4M"),
    "SYLLABUS_TM40J":    ("COURSE SYLLABUS",                     "SL 4J"),
    "SYLLABUS_TM40K":    ("COURSE SYLLABUS",                     "SL 4K"),
    "SYLLABUS_TM40L":    ("COURSE SYLLABUS",                     "SL 4L"),
    "SYLLABUS_TM40N":    ("COURSE SYLLABUS",                     "SL 4N"),
    "SYLLABUS_TM40O":    ("COURSE SYLLABUS",                     "SL 4O"),
    "SYLLABUS_TM50G":    ("COURSE SYLLABUS",                     "SL 5G"),
    "SYLLABUS_TM50H":    ("COURSE SYLLABUS",                     "SL 5H"),
    "SYLLABUS_TM50M":    ("COURSE SYLLABUS",                     "SL 5M"),
    "SYLLABUS_TM50J":    ("COURSE SYLLABUS",                     "SL 5J"),
    "SYLLABUS_TM50K":    ("COURSE SYLLABUS",                     "SL 5K"),
    "SYLLABUS_TM50L":    ("COURSE SYLLABUS",                     "SL 5L"),
    "SYLLABUS_TM50N":    ("COURSE SYLLABUS",                     "SL 5N"),
    "SYLLABUS_TM50O":    ("COURSE SYLLABUS",                     "SL 5O"),
    "EX_50G":            ("PRACTICAL EXERCISE",                  "EX-50G"),
    "EX_50H":            ("PRACTICAL EXERCISE",                  "EX-50H"),
    "EX_50M":            ("PRACTICAL EXERCISE",                  "EX-50M"),
    ...
    "SELF_STUDY_TM40A":  ("SELF-STUDY ADDENDUM",                 "SL 4A"),
    "SELF_STUDY_TM40B":  ("SELF-STUDY ADDENDUM",                 "SL 4B"),
    "SELF_STUDY_TM40C":  ("SELF-STUDY ADDENDUM",                 "SL 4C"),
    "SELF_STUDY_TM40D":  ("SELF-STUDY ADDENDUM",                 "SL 4D"),
    "SELF_STUDY_TM40E":  ("SELF-STUDY ADDENDUM",                 "SL 4E"),
    "SELF_STUDY_TM40F":  ("SELF-STUDY ADDENDUM",                 "SL 4F"),
    "SELF_STUDY_TM30":   ("SELF-STUDY ADDENDUM",                 "SL 3"),
    "SELF_STUDY_TM40G":  ("SELF-STUDY ADDENDUM",                 "SL 4G"),
    "SELF_STUDY_TM40H":  ("SELF-STUDY ADDENDUM",                 "SL 4H"),
    "SELF_STUDY_TM40M":  ("SELF-STUDY ADDENDUM",                 "SL 4M"),
    "SELF_STUDY_TM40J":  ("SELF-STUDY ADDENDUM",                 "SL 4J"),
    "SELF_STUDY_TM40K":  ("SELF-STUDY ADDENDUM",                 "SL 4K"),
    "SELF_STUDY_TM40L":  ("SELF-STUDY ADDENDUM",                 "SL 4L"),
    "SELF_STUDY_TM40N":  ("SELF-STUDY ADDENDUM",                 "SL 4N"),
    "SELF_STUDY_TM40O":  ("SELF-STUDY ADDENDUM",                 "SL 4O"),
    "SELF_STUDY_TM50G":  ("SELF-STUDY ADDENDUM",                 "SL 5G"),
    "SELF_STUDY_TM50H":  ("SELF-STUDY ADDENDUM",                 "SL 5H"),
    "SELF_STUDY_TM50M":  ("SELF-STUDY ADDENDUM",                 "SL 5M"),
    "SELF_STUDY_TM50J":  ("SELF-STUDY ADDENDUM",                 "SL 5J"),
    "SELF_STUDY_TM50K":  ("SELF-STUDY ADDENDUM",                 "SL 5K"),
    "SELF_STUDY_TM50L":  ("SELF-STUDY ADDENDUM",                 "SL 5L"),
    "SELF_STUDY_TM50N":  ("SELF-STUDY ADDENDUM",                 "SL 5N"),
    "SELF_STUDY_TM50O":  ("SELF-STUDY ADDENDUM",                 "SL 5O"),
    ...
    "DEMO_DCG_TALKING":  ("TALKING POINTS",                      "ODT-DCG-TP"),
    "DEMO_DCG_LEAVE":    ("ONE-PAGE SUMMARY",                    "ODT-DCG-LP"),
    ...
    "EX_40M":            ("PRACTICAL EXERCISE",                  "EX-40M"),
    "EX_40J":            ("PRACTICAL EXERCISE",                  "EX-40J"),
    "EX_40K":            ("PRACTICAL EXERCISE",                  "EX-40K"),
    "EX_40L":            ("PRACTICAL EXERCISE",                  "EX-40L"),
    "EX_40N":            ("PRACTICAL EXERCISE",                  "EX-40N"),
    "EX_40O":            ("PRACTICAL EXERCISE",                  "EX-40O"),
    "SYLLABUS_TM40A":    ("COURSE SYLLABUS",                     "SL 4A"),
    "SYLLABUS_TM40B":    ("COURSE SYLLABUS",                     "SL 4B"),
    "SYLLABUS_TM40C":    ("COURSE SYLLABUS",                     "SL 4C"),
    "SYLLABUS_TM40D":    ("COURSE SYLLABUS",                     "SL 4D"),
    "SYLLABUS_TM40E":    ("COURSE SYLLABUS",                     "SL 4E"),
    "SYLLABUS_TM40F":    ("COURSE SYLLABUS",                     "SL 4F"),
    # ── Train-the-Trainer (T3) ───────────────────────────────────────────────
    "T3_I":              ("TRAIN THE TRAINER",                   "T3-I"),
    "T3_F":              ("TRAIN THE TRAINER",                   "T3-F"),
    ...
    "EX_T3I":            ("PRACTICAL EXERCISE",                 "EX_T3I"),
    "EX_T3F":            ("PRACTICAL EXERCISE",                 "EX_T3F"),
    "EXAM_T3I":          ("ASSESSMENT",                         "T3-I"),
    "EXAM_T3F":          ("ASSESSMENT",                         "T3-F"),
    "INSTRUCTOR_TIER":   ("INSTRUCTOR TIER DEFINITIONS",        "SOP-TIER"),
    "C2DAO_SME":         ("SME DESIGNATION RUBRIC",             "SOP-SME"),
    "UNIT_DATA_TRAINER": ("STANDARD OPERATING PROCEDURE",       "SOP-UDT"),
    "MTT_OPERATIONS":    ("STANDARD OPERATING PROCEDURE",       "SOP-MTT"),
    "SUCCESSOR_PLANNING":("PLANNING GUIDE",                     "PG-SUCC"),
}
...
def _default_subtitle(pub_type: str, pub_number: str) -> str:
    ...
    if num.startswith("SL 1") or num == "EXEC":
        return "User/Operator Manual"
    if num.startswith("SL 2"):
        return "Administrator Manual"
    if num.startswith("SL 3"):
        return "Foundation Course Manual"
    if num.startswith("SL 4") or num.startswith("SL 5"):
...
MD_TARGETS = [
    ...
    ("maven_training/training_management/lesson_plans/T3I_LESSON_PLAN_OUTLINES.md",    "T3I_LESSON_PLAN_OUTLINES"),
    ("maven_training/training_management/lesson_plans/T3F_LESSON_PLAN_OUTLINES.md",    "T3F_LESSON_PLAN_OUTLINES"),
    # ── Syllabi ───────────────────────────────────────────────────────────────
    ("maven_training/syllabi/SYLLABUS_TMEXEC.md",                                       "SYLLABUS_TM_EXEC"),
    ("maven_training/syllabi/SYLLABUS_T3I.md",                                        "SYLLABUS_T3I"),
    ("maven_training/syllabi/SYLLABUS_T3F.md",                                        "SYLLABUS_T3F"),
    ...
    ("maven_training/syllabi/SYLLABUS_TM40M.md",                                       "SYLLABUS_TM40M"),
    ...
    ("maven_training/syllabi/SYLLABUS_TM40N.md",                                       "SYLLABUS_TM40N"),
    ("maven_training/syllabi/SYLLABUS_TM40O.md",                                       "SYLLABUS_TM40O"),
    # SL 5 syllabi
    ("maven_training/syllabi/SYLLABUS_TM50G.md",                                       "SYLLABUS_TM50G"),
    ("maven_training/syllabi/SYLLABUS_TM50H.md",                                       "SYLLABUS_TM50H"),
    ("maven_training/syllabi/SYLLABUS_TM50M.md",                                       "SYLLABUS_TM50M"),
    ...
    ("maven_training/syllabi/SYLLABUS_TM50N.md",                                       "SYLLABUS_TM50N"),
    ("maven_training/syllabi/SYLLABUS_TM50O.md",                                       "SYLLABUS_TM50O"),
    # ── Practical exercises ───────────────────────────────────────────────────
    ("maven_training/exercises/EX_10_operator_basics/EXERCISE.md",                     "EX_10_OPERATOR_BASICS"),
    ("maven_training/exercises/EX_20_no_code_builder/EXERCISE.md",                     "EX_20_NO_CODE_BUILDER"),
    ("maven_training/exercises/EX_30_advanced_builder/EXERCISE.md",                    "EX_30_ADVANCED_BUILDER"),
    # WFF exercises (A–F)
    ("maven_training/exercises/EX_40A_intelligence/EXERCISE.md",                       "EX_40A_INTELLIGENCE"),
    ("maven_training/exercises/EX_40B_fires/EXERCISE.md",                              "EX_40B_FIRES"),
    ("maven_training/exercises/EX_40C_movement_maneuver/EXERCISE.md",                  "EX_40C_MOVEMENT_MANEUVER"),
    ("maven_training/exercises/EX_40D_sustainment/EXERCISE.md",                        "EX_40D_SUSTAINMENT"),
    ("maven_training/exercises/EX_40E_protection/EXERCISE.md",                         "EX_40E_PROTECTION"),
    ("maven_training/exercises/EX_40F_mission_command/EXERCISE.md",                    "EX_40F_MISSION_COMMAND"),
    ("maven_training/exercises/EX_40G_orsa/EXERCISE.md",                               "EX_40G_ORSA"),
    ("maven_training/exercises/EX_40H_ai_engineer/EXERCISE.md",                        "EX_40H_AI_ENGINEER"),
    ...
    ("maven_training/exercises/exams/EXAM_TM40M_PRE.md",                               "EXAM_TM40M_PRE"),
    ("maven_training/exercises/exams/EXAM_TM40M_POST.md",                              "EXAM_TM40M_POST"),
    ...
    ("maven_training/exercises/exams/EXAM_TM40N_PRE.md",                               "EXAM_TM40N_PRE"),
    ("maven_training/exercises/exams/EXAM_TM40N_POST.md",                              "EXAM_TM40N_POST"),
    ("maven_training/exercises/exams/EXAM_TM40O_PRE.md",                               "EXAM_TM40O_PRE"),
    ("maven_training/exercises/exams/EXAM_TM40O_POST.md",                              "EXAM_TM40O_POST"),
    ...
    ("maven_training/exercises/exams/EXAM_TM50M_PRE.md",                               "EXAM_TM50M_PRE"),
    ("maven_training/exercises/exams/EXAM_TM50M_POST.md",                              "EXAM_TM50M_POST"),
    ...
    ("maven_training/exercises/exams/EXAM_TM50N_PRE.md",                               "EXAM_TM50N_PRE"),
    ("maven_training/exercises/exams/EXAM_TM50N_POST.md",                              "EXAM_TM50N_POST"),
    ("maven_training/exercises/exams/EXAM_TM50O_PRE.md",                               "EXAM_TM50O_PRE"),
    ("maven_training/exercises/exams/EXAM_TM50O_POST.md",                              "EXAM_TM50O_POST"),
    # T3 exams
    ("maven_training/exercises/exams/EXAM_T3I_PRE.md",                                 "EXAM_T3I_PRE"),
    ("maven_training/exercises/exams/EXAM_T3I_POST.md",                                "EXAM_T3I_POST"),
    ("maven_training/exercises/exams/EXAM_T3F_PRE.md",                                 "EXAM_T3F_PRE"),
    ("maven_training/exercises/exams/EXAM_T3F_POST.md",                                "EXAM_T3F_POST"),
    # T3 exercises
    ("maven_training/exercises/EX_T3I_instructor_certification/EXERCISE.md",           "EX_T3I_INSTRUCTOR_CERTIFICATION"),
    ("maven_training/exercises/EX_T3I_instructor_certification/ENVIRONMENT_SETUP.md",  "EX_T3I_ENVIRONMENT_SETUP"),
    ("maven_training/exercises/EX_T3F_force_multiplier/EXERCISE.md",                   "EX_T3F_FORCE_MULTIPLIER"),
    ("maven_training/exercises/EX_T3F_force_multiplier/ENVIRONMENT_SETUP.md",          "EX_T3F_ENVIRONMENT_SETUP"),
    # ── Technical manuals ─────────────────────────────────────────────────────
    ("maven_training/tm/TM_EXEC_senior_leader/TM_EXEC_SENIOR_LEADER.md",                "TM_EXEC_SENIOR_LEADER"),
    ("maven_training/tm/TM_EXEC_senior_leader/CONCEPTS_GUIDE_TMEXEC_SENIOR_LEADER.md","CONCEPTS_GUIDE_TM_EXEC_SENIOR_LEADER"),
    # T3 Trainer tracks
    ("maven_training/tm/T3_I_instructor_certification/T3_I_INSTRUCTOR_CERTIFICATION.md","T3_I_INSTRUCTOR_CERTIFICATION"),
    ("maven_training/tm/T3_I_instructor_certification/CONCEPTS_GUIDE_T3I_INSTRUCTOR_CERTIFICATION.md","CONCEPTS_GUIDE_T3I_INSTRUCTOR_CERTIFICATION"),
    ("maven_training/tm/T3_F_msc_force_multiplier/T3_F_MSC_FORCE_MULTIPLIER.md",       "T3_F_MSC_FORCE_MULTIPLIER"),
    ("maven_training/tm/T3_F_msc_force_multiplier/CONCEPTS_GUIDE_T3F_MSC_FORCE_MULTIPLIER.md","CONCEPTS_GUIDE_T3F_MSC_FORCE_MULTIPLIER"),
    ...
    # SL 4/5 overview pages
    ("maven_training/tm/TM_40_overview/TM_40_OVERVIEW.md",                             "TM_40_OVERVIEW"),
    ("maven_training/tm/TM_50_overview/TM_50_OVERVIEW.md",                             "TM_50_OVERVIEW"),
    # WFF tracks (A–F, operational)
    ...
    ("maven_training/tm/TM_40M_ml_engineer/TM_40M_ML_ENGINEER.md",                     "TM_40M_ML_ENGINEER"),
    ("maven_training/tm/TM_40M_ml_engineer/CONCEPTS_GUIDE_TM40M_ML_ENGINEER.md",       "CONCEPTS_GUIDE_TM40M_ML_ENGINEER"),
    ...
    ("maven_training/tm/TM_40N_ux_designer/TM_40N_UX_DESIGNER.md",                   "TM_40N_UX_DESIGNER"),
    ("maven_training/tm/TM_40N_ux_designer/CONCEPTS_GUIDE_TM40N_UX_DESIGNER.md",     "CONCEPTS_GUIDE_TM40N_UX_DESIGNER"),
    ("maven_training/tm/TM_40O_platform_engineer/TM_40O_PLATFORM_ENGINEER.md",       "TM_40O_PLATFORM_ENGINEER"),
    ("maven_training/tm/TM_40O_platform_engineer/CONCEPTS_GUIDE_TM40O_PLATFORM_ENGINEER.md","CONCEPTS_GUIDE_TM40O_PLATFORM_ENGINEER"),
    # Technical specialist advanced tracks (50G–O)
    ...
    ("maven_training/tm/TM_50M_ml_engineer_advanced/TM_50M_ML_ENGINEER_ADVANCED.md",   "TM_50M_ML_ENGINEER_ADVANCED"),
    ("maven_training/tm/TM_50M_ml_engineer_advanced/CONCEPTS_GUIDE_TM50M_ML_ENGINEER_ADVANCED.md","CONCEPTS_GUIDE_TM50M_ML_ENGINEER_ADVANCED"),
    ...
    ("maven_training/tm/TM_50N_ux_designer_advanced/TM_50N_UX_DESIGNER_ADVANCED.md", "TM_50N_UX_DESIGNER_ADVANCED"),
    ("maven_training/tm/TM_50N_ux_designer_advanced/CONCEPTS_GUIDE_TM50N_UX_DESIGNER_ADVANCED.md","CONCEPTS_GUIDE_TM50N_UX_DESIGNER_ADVANCED"),
    ("maven_training/tm/TM_50O_platform_engineer_advanced/TM_50O_PLATFORM_ENGINEER_ADVANCED.md","TM_50O_PLATFORM_ENGINEER_ADVANCED"),
    ...
    ("maven_training/tm/TM_40N_ux_designer/SELF_STUDY_ADDENDUM.md",                  "SELF_STUDY_TM40N_UX_DESIGNER"),
    ("maven_training/tm/TM_40O_platform_engineer/SELF_STUDY_ADDENDUM.md",            "SELF_STUDY_TM40O_PLATFORM_ENGINEER"),
    ...
    ("maven_training/tm/TM_50M_ml_engineer_advanced/SELF_STUDY_ADDENDUM.md",          "SELF_STUDY_TM50M_ML_ENGINEER_ADVANCED"),
    ...
    ("maven_training/tm/TM_50N_ux_designer_advanced/SELF_STUDY_ADDENDUM.md",         "SELF_STUDY_TM50N_UX_DESIGNER_ADVANCED"),
    ("maven_training/tm/TM_50O_platform_engineer_advanced/SELF_STUDY_ADDENDUM.md",   "SELF_STUDY_TM50O_PLATFORM_ENGINEER_ADVANCED"),
